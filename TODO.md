...
| F1-DL.9 | F1-DeepLore | R9 — Antologia Vol 2 (14 contos in-character = 44764 pal): Gus 2746 + Cauã 2969 + Iara 3039 + Bento 3231 + Linda 3303 + Dante 3379 + Jaci 3797 + Sterling 3172 + Vorto 3556 + Pyotor 3251 + Vênea 2962 + Mariana 3456 + Verônica 2705 + Helíaco 3198. **PARALELO ORGÂNICO pós-pivot ADR-001** | Média | F1-DL.8 | Alta | ✅ Done 2026-05-20 | — |
...
| F2-E.5 | F2-Engine | TurnCombat ESCOPO EXPANDIDO (canon 2026-05-21): combina F2-E.5 (engine core) + F2-G.5 (cartas/combate). Initiative queue + state machine (SetupPhase→TurnStart→ActionSelect→ActionResolve→TurnEnd→CheckEnd) + 4 action types (Attack/Defend/UseCard/Flee) + damage calc + status effects framework + **Codex base 5 cartas + 5 famílias mockup canon (Elétrico/Bioquímico/Sônico/Cinético/Criptográfico)** + **party 4v4** + **AI básica enemy** + 3 modificadores Object/Stream/Null + stack 3 slots compilação. POCO engine/foundation/turn_combat/ (records CombatActor/CombatAction/CombatResult/CombatLogEntry/StatusEffect/Card/CardFamily). Node game/scripts/foundation/turn_combat/CombatManager.cs (AutoLoad). Integration CombatBus signals canon + PlayerBus stats hook. TDD 15+ test cases. Save mid-fight postpone. Esforço alto ~1000-1500 linhas + tests | Alta | F2-E.2 | Alta | ⏳ Pendente (escopo expandido 2026-05-21) | — |
