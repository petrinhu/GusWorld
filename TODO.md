...
| F1-DL.REFAC | F1-DeepLore | Refactor fluidez prose deep-lore + retrofit easter eggs maçônicos — (a) reduz repetição marcadores ritualísticos (`articulada em registro`, `preservada em registro institucional`, `em horizonte temporal cumulativo`) preservando conteúdo canônico/NPCs/geografia/datações/axiologia/Fibonacci. (b) insere easter eggs maçônicos canon (memo `project_eastereggs_maconaria_canonica`): pavimento tesselado, ashlar bruto/polido, esquadro+compasso, Colunas Boróstoma+Janor, acaceiro-tronco-vermelho, avental couro, 3-5-7 degraus, 47ª proposição, cordão 89 nós, Helíaco Vyr=Hiram Abiff echo (morte mística + 3 aprendizes infiéis). Aplicar §§6-8 já escritas + §§9-10 quando concluídas. Via narrative-writer (briefing fluência Stephenson/Krasznahorkai + densidade técnica + easter eggs densidade ~10-15%). Bloqueia F5-BK.1 | Alta | F1-DL.1.10 | Alta | ⏳ Pendente | — |
