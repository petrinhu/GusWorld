// gus/domain/cards/card_enums.hpp
//
// Enums POCO de VOCABULARIO DE CARTA (ATOM-2, extraidos de
// gus/domain/combat/combat_enums.hpp): a identidade mecanica de uma carta
// (familia, tipo-base, forma de alvo, modificador, regra de empilhamento, status,
// tier/categoria/gatilho/efeito do executor techMagic, filtro de lado). POCO puro,
...
// CANONICO destes enums. gus/domain/combat/combat_enums.hpp virou FACHADA - inclui
// este header e re-exporta os nomes em gus::domain::combat via using-declaration,
// preservando a IDENTIDADE de tipo (nao e um typedef/copia) para os ~90
// consumidores existentes de combat_enums.hpp continuarem compilando intocados.
// cards/ NAO pode incluir combat/ (inversao de dependencia - gate de camadas).
//
// Ordinais e comentarios de cada enum sao INTOCADOS na migracao (contrato binario
// do save/rede, mesmo racional do header de origem).
//
// Cross-ref: gus/domain/combat/combat_enums.hpp (fachada);
//            engine/foundation/turn_combat/CombatEnums.cs;
//            docs/design/mecanicas/combat.md secao 3/6/7/8/9/16; ADR-006; ADR-016;
//            ADR-019 (decomposicao atomica, generalizada ao nivel de modulo aqui).

#ifndef GUS_DOMAIN_CARDS_CARD_ENUMS_HPP
#define GUS_DOMAIN_CARDS_CARD_ENUMS_HPP
...
// de EffectSpec, ver cards/card_records.hpp) que o Tavus-Drive executa. Record-only
// neste step (nenhuma logica de resolucao ainda). APPEND-ONLY dali em diante (contrato
...
#endif  // GUS_DOMAIN_CARDS_CARD_ENUMS_HPP
