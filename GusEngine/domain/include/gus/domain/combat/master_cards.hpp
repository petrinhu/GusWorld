...
//
// ESCOPO: as 13 cartas cujos efeitos escolhidos (docs/design/roster-analogos/
// _EFEITOS-ESCOLHIDOS.md) cabem nos 9 EffectKind ja implementados por
// gus/domain/combat/techmagic.cpp (ApplyStatus, Leech, Reflect, HypotenuseCombo,
// RepeatLastAction, ChainDamage, DelayAction, DamageQuantize) OU sao posse-only
// (fora-de-combate/passiva-flag, sem programa ainda). von Neumann e Giordano Bruno exigem
