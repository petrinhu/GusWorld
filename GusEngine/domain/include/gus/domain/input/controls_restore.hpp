...
//     etc.), cobrindo as 30 actions do ActionRegistry (higiene M2/higiene-controles-
//     godot removeu as 7 actions de camera orbital 3/4 da era Godot, mortas
//     pos-ADR-008). Usado pelo migrator V3->V4 e como fallback quando nao ha save
//     nenhum (jogo novo / arquivo ausente). Pura, deterministica.
...
// Esquema de controles de FABRICA (fonte unica). Cobre as 30 actions canonicas, com
