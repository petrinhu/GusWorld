...
//     item 9, Mises/Calc-Edge - campo aditivo SEGUINTE, MESMO padrao append-only; tier =
//     DIFICULDADE-TABELA-DADO, EnemyTier: Trash/Elite - campo aditivo SEGUINTE, MESMO
//     padrao append-only. NOTA: este formato NAO tem discriminador de versao (nenhum
//     campo de schema-version no envelope) - cada campo novo append-only e seguro
//     SOMENTE enquanto nao houver .gdt persistido com o schema anterior; nao ha nenhum
//     .gdt em disco/repo hoje.)
//
