...
// (B7 correcao 2026-08-01, revertida no mesmo dia) - save_load_scroll_needed
// foi removida: era matematica de visibilidade de lista implementada em casa,
// exatamente o que a LEI do projeto proibe reimplementar quando cabe no
// glintfx (ver o comentario de SaveLoadScreen::reload_(), save_load_menu_loop.
// cpp). O achado que a gerou (scroll_element_into_view reancora ao topo mesmo
// com o item ja visivel, -68px medidos) continua real e documentado, mas o
