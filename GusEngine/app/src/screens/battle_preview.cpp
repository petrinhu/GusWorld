...
// AC-E11 A3 (ADR-019): join/resolve_asset_dir/resolve_hit_sfx_path/resolve_ui_sfx_path/
// load_gus_sprite_set/retrato_file_for MORARAM pra battle_assets.cpp (resolucao de
// paths/loaders de asset isolada da casca de render/setup, ver gus/app/screens/
// battle_assets.hpp). battle_preview.cpp inclui o header (via battle_preview.hpp) e so
// CONSOME essas funcoes daqui pra baixo - zero mudanca de comportamento, so de arquivo.
...
// AC-E11 A3 (ADR-019): resolve_retratos_dir/resolve_status_icons_dir/resolve_music_path/
// resolve_intent_icons_dir MORARAM pra battle_assets.cpp (ver acima).
