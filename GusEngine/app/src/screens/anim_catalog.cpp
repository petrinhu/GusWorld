...
// gus/core/asset_paths.hpp = kGusSpritesDir, hoje sprites/personagens_inspirados/gus) via
// std::filesystem. Camada app/ (toca disco); nenhuma chamada SDL/GPU aqui - so monta caminhos.
