...
- **Presença de elementos velados:** NAO forcar padrão numérico/arquitetural-ritual nestes 5 icones-mae (sao simbolos de sistema, devem ser limpos). Elementos velados entram em arte de cenario/personagem, nao em HUD funcional.
...
**Reforcar (canon):** estetica de mecanico da Periferia Industrial / Ferrovelhos (sucata, hardware salvado) + DEDOS MODULARES (upgrade canon) + harness de utilidade. Aparencia AMIGAVEL e competente (engana o player). Detalhe de traicao velado: UM detalhe frio errado (LED vermelho-anomalia escondido entre o ambar), velado, nunca obvio (foreshadow canon; player Knowledge alta nota). NAO rotular.
