...
6. **Elementos velados espaciais canon** (blockout secao 6): vaos de janela em proporcao 1:1:2:3:5, escada com degraus em 3, 5 e 7, fachadas em sequencia numerica. Aplico com presença esparsa e deliberada, velado.
...
### Elementos velados (presença esparsa, nao rotular)
- Vaos de janela das fachadas em proporcao 1:1:2:3:5 (blockout secao 6).
- Pavimento tesselado: padrao xadrez/tesselado de pedra (eco arquitetural-ritual canon, velado: pavimento mosaico).
- Escada do choke = degraus em 3, 5 e 7.
- Numeros da escada numerica canonica em contagens de ornamento quando couber. NUNCA narrar; leitor atento nota.
...
**Reforcar:** pavimento TESSELADO rachado (landmark textural da praca + elemento velado do mosaico). Concreto azulado frio. Chao navegavel le como navegavel.
...
**Reforcar:** o LANDMARK-ANCORA do hub (blockout: fonte de latao central girando). Latao Era 2 quente contra a praca fria. Elemento velado: contagem de ornamentos/jatos pode seguir a escada numerica canonica, velado.
...
**Reforcar:** casa-bloco da praca. Angulos agudos + simetria quebrada (corporativo uncanny, style-guide secao 7). Janelas em 1:1:2:3:5 (elemento velado, blockout secao 6). Neon cyan so como costura.
