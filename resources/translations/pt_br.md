...
>
> Formato: `## CHAVE_UPPER_SNAKE` + valor abaixo.
>
...
# input_remap_backup desde o V4; a tela só compara contra os
...
### Cartas especiais dos mestres (executor techMagic; alcunha do efeito, valor provisorio)
...
## §12. Configurações de Jogo (F4-3.8, toggles do prompt de saída)

## SETTINGS_GAME
Jogo

## SETTINGS_EXIT_SAVE_SLOT_PROMPT
Perguntar onde salvar ao sair

## SETTINGS_EXIT_SKIP_AUTOSAVE
Pular autosave ao sair sem salvar
...
## §13. Prompt de salvar ao sair (F4-3.8 Bloco 4)
