...
### Personalidade FORA de combate (o padrão)
- **Tímido e desconfiado no geral**, mas **simpático e leal quando se apega**: confia TOTALMENTE em quem conhece de verdade. O círculo pequeno de confiança (a party) é o oposto da frieza dele com estranhos.
- **Um pouco estressado com hardware.** Tudo o que ele tem é de segunda mão, remanufaturado, ou montado por ele com o pai (gambiarras). O hardware o trai; o **software obedece**. Por isso ele PREFERE codar a montar.
- Enquadra-se nos traços canônicos de **criança superdotada** (pesquisa 2026-07-14, fontes no fim), que reforçam e explicam a definição acima:
  - **Overexcitabilities (Dabrowski):** intensidade intelectual, emocional e sensorial, com limiar baixo de sobrecarga (o "estresse").
  - **Perfeccionismo:** padrão altíssimo; frustração quando algo falha (a gambiarra que não funciona).
  - **Desenvolvimento assíncrono:** intelecto avançado num emocional de 11 anos; sensível, reflexivo, a moral pesa (a base da timidez e da desconfiança).
  - **Solidão do prodígio + poucos pares verdadeiros:** solitário por padrão, mas 1 ou 2 pares intelectuais reais mudam tudo (a party vira o círculo de confiança).

### Personalidade EM batalha (a virada, decisão do criador 2026-07-14)
**Em combate, a personalidade de Gus muda TOTALMENTE:** o menino tímido e desconfiado vira o **herói infantil destemido, LÍDER da party.** Confiante, decidido, comanda. É a face **"Dragon"** dele (o codinome de combate): fora da luta ele hesita com estranhos, na luta ele é o Dragon que ninguém intimida.
...
5. **A reversão:** desfazer o efeito do erro é uma **missão extra OBRIGATÓRIA**, estimulada pela party, mas **sob comando do amigo TANKER (Bento "Requiem")**. Lição embutida: **não se pode ser perfeito em tudo**; a **necessidade de pedir ajuda quando preciso** evita erros desnecessários e previsíveis. O prodígio segue a liderança do tanque justo onde falhou sozinho.
   - **Gatilho condicionado ao Bento recrutado (decisão do criador 2026-07-14, achado PS-R7):** o recrutamento é de **ordem livre** (só o Cauã é fixo #1), então o beat da reversão **NÃO dispara em % fixo de campanha**: dispara na **PRIMEIRA oportunidade DEPOIS que o Bento se junta à party**. Preserva a ordem livre e mantém a lição nomeada do Bento (é ELE, o tanker, quem comanda). Se o jogador deixa o Bento pro fim, o arco acontece mais tarde; nada trava. A falha em si (beat 1) pode ser plantada antes; a descoberta (3), a conversa (4) e a reversão (5) é que ficam gated pelo Bento estar presente.

Casa com o perfeccionismo canônico do Gus (base gifted-kid), com a party como círculo de confiança, e com a dualidade tímido-fora / destemido-dentro (aqui a armadura da confiança em batalha racha na vida real).

**FALHA CONCRETA DEFINIDA (brainstorm do líder, 2026-07-18; "combine tudo": otimização + código + decisão fria + aviso ignorado, num pecado só):** o Gus tenta **OTIMIZAR** uma **infra crítica de função dupla**, que serve a um **aliado/facção** E à **missão principal** ao mesmo tempo. Escreve um patch/conjuro que acha elegante (magia = software). **O Bento o avisa** (a fala Asmódico dele já canônica no guia de voz: "a peça velha te ensina onde a nova vai quebrar de novo"), e o Gus, confiante na própria cabeça (a frieza do cálculo, a face Dragon fora de hora), **ignora e aplica sozinho**. O perfeccionista não pede ajuda, o oposto exato do Asmódico "recusa antes de errar". O patch tem um **BUG com custo oculto** (Bastiat, "o que não se vê") que só se manifesta depois: abre uma **brecha que a Sterling/FIR explora**, prejudicando a **campanha** (missão) E o **aliado** (facção) de uma vez. Dano duplo, público e com laço. O perfeccionismo então faz o Gus **esconder que o bug foi DELE e mentir** sobre a causa (beats 2-3). A reversão é **comandada pelo Bento** (beat 5): ele avisou, ele conduz, a lição encarnada; e aprofunda o conflito Gus×Bento (moderno vs tradição) rumo à aliança do ato 3.

> **Ainda aberto (pra detalhamento posterior):** (a) o SISTEMA específico, qual infra/aliado (candidatos: rede de antenas do Underground/Linda, ou uma infra neutra de que a missão depende); (b) a **cronologia exata** no `arco-principal.md` (com o `narrative-designer`; descoberta/conversa/reversão disparam na 1ª oportunidade DEPOIS que o Bento entra na party, gate canônico); (c) a **redação** do diálogo da cena de perdão (beat 4) via `narrative-writer`.
...
- Resolve por **lógica, não por força** (Pillar 4): analisa em voz alta, usa jargão de código como muleta natural.
- **Rage leve cômico contra hardware x software** é o tic de humor recorrente. O software é o aliado justo; o hardware velho é o vilão do dia a dia.

### Banco de falas de rage leve cômico (hardware x software): rascunho do criador + orquestrador
(A primeira é a canônica do criador; as demais são geradas no mesmo espírito, para o `narrative-writer` selecionar/expandir.)

1. "Essas porcarias velhas nunca funcionam direito. Por isso prefiro codar a montar…"
2. "Software não enferruja. Já esse cabo aqui, é capaz de criar vida própria só pra me irritar."
3. "Comprei 'seminovo'. Ou seja: já morreu uma vez e ressuscitaram na marra."
4. "No código, se dá erro, ele ao menos AVISA. Esse capacitor só solta fumaça e finge que a culpa é minha."
5. "Meu pai chama de gambiarra. Eu chamo de arquitetura resiliente sob restrição de orçamento."
6. "Se hardware fosse honesto, vinha com um README dizendo em que dia ele pretende falhar."
7. "Solda fria de novo. Eu escrevo mil linhas sem errar uma chave, mas encostar um ferro quente já é demais pra esse mundo."
...
## CAUÃ "VOLT" BERENGER (guia de voz bilíngue pt-br/en-intl, definido pelo líder, 2026-07-18)

> **Status:** guia de voz aprovado para uso. Complementa (não substitui) o canon de personagem em `characters/caua-volt.md`. Fonte de falas concretas e reutilizáveis para o `narrative-writer` selecionar/expandir na redação final (mesmo modelo do "Banco de falas" do Gus acima).
>
> **Cross-ref:** `characters/caua-volt.md` (canon completo, wound/want/need/flaw, memórias formativas, pulled quotes), `characters/party.md` (matriz de linguagens-âncora, dinâmicas de conflito), `characters/gus.md` (voice do Gus pro banter), `guia-dialogos.md` (formato: aspas, zero em-dash, beat de ação em vez de tag com advérbio), `gus-apartes-c-arcane.md` (sistema canônico separado de apartes+revides do Gus; ver nota na seção de banter abaixo para não confundir os dois sistemas).
>
> **Regra bilíngue:** cada fala concreta vem em **pt-br e en-intl lado a lado**. Gíria NÃO é traduzida literal; o en-intl busca o equivalente que soa igual de natural na boca de um moleque de 13 anos de comunidade, sem modismo que envelhece. Onde a escolha não é óbvia, a nota diz o porquê. Escolhas marcadas **(PROPOSTA, confirmar)** ainda não têm aval do líder.

### 1. Resumo da voz

Cauã tem 13 anos, é Striker dos Dutos Infernais, linguagem-âncora **Pythia**. Na superfície é energia alta: frases curtas, exclamativas, gíria de comunidade atemporal ("mano", "vambora", "firmeza", "tô", "sussa"), tic físico de estalar os dedos quando empolga (descarrega um micro-pulso involuntário, efeito visual cyan). Por baixo da energia mora uma camada de contenção emocional aprendida cedo: aos 8 anos, na notícia da morte do irmão Davi, ele não gritou nem chorou na hora, foi pro quarto e ficou 5 dias quase mudo. Essa contenção não desaparece quando ele cresce, ela SOMA à energia: ele sabe exatamente quando parar de ser o garoto empolgado e virar o garoto quieto. Nunca os dois ao mesmo tempo. O teste de voz única (`party.md`): se uma fala do Cauã sai igualmente natural na boca do Gus ou da Jaci, ela está errada, refazer.

### 2. Combate (instinto + protetor)

Contraponto ao Gus/"Dragon" (líder frio e calculista em batalha): o Cauã é o calor da linha de frente. Grita, avança primeiro, mas o impulso dele é sempre proteger a party, nunca só "brilhar sozinho" (ele é Striker E guardião da comunidade). Pool de barks por momento, para o `narrative-writer` escolher/variar (evitar repetir sempre a mesma linha).

**Iniciar / avançar**
- PT: "Vambora! Compila e roda!" (estala os dedos, pulso cyan visível)
- EN: "Let's go! Compile and run!" (snaps his fingers, cyan pulse flickers)
- PT: "Firmeza, mano. Eu vou na frente."
- EN: "We're solid, bro. I'm taking point."

**Descarregar o EMP**
- PT: "Toma essa carga!" (soco no ar, onda cyan expande dos nós acumuladores)
- EN: "Eat this charge!"
- PT: "Descarregando... AGORA!"
- EN: "Discharging... NOW!"

**Proteger / cobrir um aliado**
- PT: "Fica atrás, eu seguro!" (se posiciona entre o aliado e o inimigo)
- EN: "Get behind me, I got this!"
- PT: "Passa por mim. Eu aguento o resto."
- EN: "Get past me. I'll hold the rest."

**Aliado em perigo (HP baixo)**
- PT: "Ei! Aguenta aí, eu chego!" (voz sobe, exo-botas disparam)
- EN: "Hey! Hold on, I'm coming!"
- PT: "Não. Não hoje." (frases cortadas, contenção sob pressão) "Eu chego."
- EN: "No. Not today." (clipped, holding it together) "I'm coming."

**Vitória**
- PT: "É ISSO, mano!" (soca o ar, sorriso aberto)
- EN: "That's it, bro!"
- PT: "Compilou. Rodou. Ganhamos."
- EN: "Compiled. Ran. We won."

**Tomar dano / perigo**
- PT: "Ah, foi mal, essa doeu." (ri torto, sem reclamar de verdade)
- EN: "Ah, my bad, that one hurt."
- PT: "Tô de pé. Segue o jogo."
- EN: "Still standing. Keep going."

**Retomar fôlego**
- PT: "Só um segundo... tô voltando." (respira fundo, estala o dedo devagar, controlado, diferente do tic de empolgação)
- EN: "Just a sec... I'm coming back." (slow controlled finger-snap, different rhythm from the hype tic)

### 3. Banter com o Gus (rivalidade fraterna, ponto pra cada lado)

**Nota de escopo:** estas trocas são banter genérico de caminhada/descanso, distinto do sistema canônico de apartes+revides do Gus (`gus-apartes-c-arcane.md`, aprovado linha a linha, com régua fato x juízo sourced). Aqui NÃO se introduz fato técnico novo carente de fonte: os argumentos usam só o que já é canon em `party.md`/`caua-volt.md` (Pythia é rápida de escrever, perdoa erro, "te abraça"; C-Arcane é baixo-nível mas legível). Se o líder quiser este banter promovido ao mesmo rigor sourced do sistema de apartes, é decisão separada dele.

**Regra do líder:** ninguém humilha. Cada um marca ponto; às vezes o Cauã fecha vencendo.

**B1, "o abraço"**
- CAUÃ (PT): "Pythia te abraça, Gus. C-Arcane só te processa."
- CAUÃ (EN): "Pythia hugs you, Gus. C-Arcane just processes you."
- GUS (PT): "Prefiro ser processado direito a ser abraçado errado." (pausa de 1s, processando)
- GUS (EN): "I'd rather be processed right than hugged wrong." (1-second pause, processing)
- CAUÃ (PT): "Errado não. Rápido." (sorriso torto, fecha o ponto)
- CAUÃ (EN): "Not wrong. Fast." (crooked grin, closes the point)
- *Resultado: Cauã fecha.*

**B2, "o parêntese esquecido"**
- CAUÃ (PT): "Esqueci um parêntese ontem. Pythia nem ligou, rodou igual."
- CAUÃ (EN): "Forgot a parenthesis yesterday. Pythia didn't even care, ran anyway."
- GUS (PT): "Rodou errado, então."
- GUS (EN): "Ran wrong, then."
- CAUÃ (PT): "Rodou RÁPIDO. Errado eu conserto depois."
- CAUÃ (EN): "Ran FAST. I fix wrong later."
- GUS (PT): "Depois de quebrar o quê?"
- GUS (EN): "After breaking what?"
- CAUÃ (PT): (dá de ombros) "Nada que não dava pra remendar."
...
- GUS (PT): "Compila e roda não é argumento, Cauã. É bordão."
- GUS (EN): "Compile and run isn't an argument, Cauã. It's a catchphrase."
- CAUÃ (PT): "Bordão que funciona TODA vez é argumento, mano."
- CAUÃ (EN): "A catchphrase that works EVERY time is an argument, bro."
- *Resultado: empate cômico, ninguém cede, os dois riem e seguem andando.*

**B4, "o abraço, parte 2" (o momento morno)**
- GUS (PT): "Cauã. Por que 'abraça'? Por que não 'aceita', 'permite', 'tolera'?"
- GUS (EN): "Cauã. Why 'hugs'? Why not 'accepts', 'allows', 'tolerates'?"
- CAUÃ (PT): "Porque quando eu erro, mano, eu não quero ser TOLERADO." (beat, mais sério do que o normal) "Eu quero ser pego antes de cair."
- CAUÃ (EN): "Because when I mess up, bro, I don't want to be TOLERATED." (beat, more serious than usual) "I want to be caught before I fall."
- GUS (PT): (pausa de 1s) "...isso eu não tenho resposta técnica."
- GUS (EN): (1-second pause) "...I don't have a technical answer for that."
- *Resultado: Cauã fecha, e fecha fundo (subtexto do wound sem nomear o wound).*

**B5, "ensinar os pequenos"**
- CAUÃ (PT): "Os moleques novos dos Dutos aprendem Pythia em uma tarde, Gus. UMA tarde."
- CAUÃ (EN): "The new kids in the Ducts learn Pythia in one afternoon, Gus. ONE afternoon."
- GUS (PT): "Aprendem a escrever. Não aprendem por que funciona."
- GUS (EN): "They learn to write it. Not why it works."
- CAUÃ (PT): "Eles têm OITO anos e já estão PROTEGENDO o próprio bloco. 'Por que funciona' vem depois."
- CAUÃ (EN): "They're EIGHT and already protecting their own block. 'Why it works' comes later."
- *Resultado: Cauã fecha (o argumento bate direto no goal dele: proteger a comunidade jovem).*

**B6, "o relógio errado" (callback pós-combate)**
- GUS (PT): (limpando o Tavus-Drive, sem olhar) "Se você tivesse escrito aquele pulso em C-Arcane, tinha disparado antes."
- GUS (EN): (wiping down his Tavus-Drive, not looking up) "If you'd written that pulse in C-Arcane, it would've fired sooner."
- CAUÃ (PT): "Ia disparar antes SIM. Na semana que vem. Quando eu terminasse de escrever."
- CAUÃ (EN): "It would've fired sooner, YEAH. Next week. When I finished writing it."
- GUS (PT): (pausa) "...ponto seu."
- GUS (EN): (pause) "...your point."
- *Resultado: Cauã fecha, e o Gus admite (raro, sinal de respeito real).*

### 4. Momentos pesados / contenção

Regra de voz: quando é hora pesada, o bordão SOME. Sem "compila e roda", sem estalar dedo empolgado, sem exclamação. Frases curtas viram frases INCOMPLETAS, cortadas antes do fim, ou ele simplesmente não fala e faz alguma coisa com as mãos (chá, uma ferramenta, qualquer coisa) até a hora de falar chegar. É a mesma contenção da memória formativa dos 12 anos (a cozinha, o chá, o silêncio de 3 minutos antes dele falar).

- **Pulled quote canônico (não reescrever, só usar):** "Eu fui rápido. Eu também devia ter ficado." / EN (aprovado pelo líder 2026-07-18): "I was fast. I should've stayed too."
- **Pulled quote canônico:** "Volt não é só voltagem. Voltar também conta." / EN: **PENDENTE** (decisão do líder 2026-07-18: fica só em pt-br por ora; o trocadilho Volt/voltar não sobrevive ao inglês, e como a tradução en-intl é pós-v1.0.0, a escolha final foi adiada pra decidir com calma).

Falas novas reutilizáveis, mesmo registro:

- PT: "Não precisa falar nada. Só fica." (oferecido a um aliado ferido/de luto, não a si mesmo)
- EN: "You don't have to say anything. Just stay."
- PT: "Eu não choro fácil." (pausa) "Isso não quer dizer que não doeu."
- EN: "I don't cry easy." (pause) "Doesn't mean it didn't hurt."
- PT: "Deixa eu ficar quieto um pouco." (pausa) "Só um pouco."
- EN: "Let me be quiet for a bit." (pause) "Just a bit."
- PT: (sobre Davi, se alguém pergunta) "Ele ia gostar de você." (não elabora, muda de assunto)
- EN: "He would've liked you." (doesn't elaborate, changes the subject)
- PT: (payoff Subestação 7, retorno de aprofundamento) "É aqui." (pausa longa) "Eu nunca trouxe ninguém aqui."
- EN: "This is it." (long pause) "I never brought anyone here."

### 5. Registro e gíria

Paleta atemporal (aprovada pelo líder: "mano", "vambora", "firmeza", "tô", "sussa"), sem modismo datável. Equivalentes en-intl abaixo; onde não é óbvio, a nota explica a escolha.

| Gíria pt-br | Uso | Equivalente en-intl | Nota |
|---|---|---|---|
| mano | vocativo afetuoso, o Cauã chama o Gus assim especificamente (canon: "Chama o Gus de mano") | **bro** (aprovado pelo líder 2026-07-18 como tradução fixa do endereçamento ao Gus) | "bro" mantém o calor fraterno; "man" fica como variante mais neutra em frases exclamativas soltas ("Ah, man!") quando não é vocativo direto |
| vambora | convite pra agir/ir, contração de "vamos embora" | **let's go** | mantém a energia curta e monossilábica de comando; "c'mon" serve como variante quando é mais chamado de atenção que ordem de marcha |
| firmeza | confirmação/aprovação, "tá certo, combinado, sólido" | **solid** / **we're good** | "solid" pra resposta seca de aprovação; "we're good" quando é asseguramento direto a um aliado nervoso |
| tô | contração oral de "estou" | contrações naturais do inglês (I'm, I've, gonna, gotta) | não é gíria lexical, é REGISTRO; o inglês já contrai por padrão, então não força uma gíria extra ali, só mantém o texto sempre contraído (nunca "I am", sempre "I'm") |
| sussa | "de boa, relaxado, sem estresse" | **chill** / **easy** | "chill" quando ele acalma outro personagem; "easy" quando é auto-tranquilizador antes de agir sozinho |
| compila e roda (bordão-assinatura) | ação vale mais que perfeição, "para de pensar e faz" | **compile and run** (aprovado pelo líder 2026-07-18) | mantém o trocadilho de programação E a cadência monossilábica-punchy; alternativa descartada: "ship it" (soa natural em inglês mas perde o trocadilho específico de "compilar") |
| Pythia te abraça | personificação afetuosa da linguagem-âncora | **Pythia hugs you** (aprovado pelo líder 2026-07-18) | tradução literal deliberada: "hugs" preserva a imagem carinhosa/infantil que "abraça" carrega; alternativa descartada "Pythia's got you" (mais idiomática em inglês, mas perde a imagem física do abraço, que é o ponto emocional da frase) |

### 6. Não fazer

- Não deixar o bordão de empolgação vazar pra cima de um momento pesado (contradiz a contenção canônica: "sabe quando calar").
- Não fazer "garoto durão sem sentimento" (regra já canônica em `caua-volt.md`: ele chora quando é hora, e o Gus respeita).
- Não infantilizar: tem 13 anos, lidera comunidade, é adulto em maturidade mesmo com energia de moleque.
- Não deixar ele "vencer" toda discussão com o Gus nem "perder" todas: o banter é equilíbrio, ninguém humilha (regra do líder).
- Não usar arma de fogo; o EMP é magia cinética (Pillar 2), nunca tratado como arma real.
- Não traduzir gíria palavra por palavra perdendo o registro (regra bilíngue): o teste é "soa natural na boca de um moleque de 13 de comunidade em inglês", não "é a tradução literal do dicionário".
- Não usar modismo/trend datável em nenhuma das duas línguas (a gíria tem que envelhecer bem).
- Não escrever travessão/em-dash em nenhuma fala (convenção do projeto: só aspas; beat de ação ou reticências resolvem interrupção).
- Teste de voz única (herdado de `party.md`): se uma fala do Cauã sair igualmente natural na boca do Gus ou da Jaci, ela está errada, refazer.

---

## JACI "PROXY" VANDERBIST (guia de voz bilíngue pt-br/en-intl, definido pelo líder, 2026-07-18)

> **Status:** guia de voz aprovado para uso. Complementa (não substitui) o canon de personagem em `characters/jaci-proxy.md`. Fonte de falas concretas e reutilizáveis para o `narrative-writer` selecionar/expandir na redação final (mesmo modelo do "Banco de falas" do Gus e do guia do Cauã acima).
>
> **Cross-ref:** `characters/jaci-proxy.md` (canon completo, wound/want/need/flaw, memórias formativas, pulled quotes), `characters/party.md` (matriz de linguagens-âncora, dinâmicas de conflito, regra de romance nuançada §"Sem triângulos"/"Não fazer", atualizada 2026-07-18), `characters/gus.md` (voice do Gus pro subtexto), `characters/caua-volt.md` (contraste Pythia-velocidade x Pythia-precisão), `guia-dialogos.md` (formato: aspas, zero em-dash, beat de ação em vez de tag com advérbio), `comic-reliefs/cena-09-off-by-one.md` "Off-by-one" (script canônico do tic).
>
> **Regra bilíngue:** cada fala concreta vem em **pt-br e en-intl lado a lado**. Jaci tem pouca gíria (registro científico/suave), então o risco de perda na tradução é menor que no Cauã; o cuidado aqui é manter a cadência maternal-mas-11-anos e a precisão clínica soando igualmente naturais nas duas línguas. Onde a escolha não é óbvia, a nota explica o porquê. Como este é o primeiro guia de voz da Jaci, **todas** as escolhas en-intl abaixo são **(PROPOSTA, confirmar)**, mesmo quando não repetido em cada linha.

### 1. Resumo da voz

Jaci tem 11 anos (a mesma idade do Gus), é Healer/buffer biológica do Vilarejo do Pelicano Branco (Selve Sombria), linguagem-âncora **Pythia**. Na superfície é a voz mais macia da party: frases médias, cadência maternal apesar da idade, vocabulário científico misturado com botânica. Nunca nomeia doença pelo nome clínico, nomeia pelo sintoma ("o que mexe na linfa, não o que mexe no sangue, são coisas diferentes"). Tic: conta e reconta ampolas o tempo todo, dentro e fora de combate; quando o número não fecha (off-by-one, `comic-reliefs/cena-09-off-by-one.md`), ela trava numa pequena espiral até resolver.

Por baixo da voz macia mora a mesma linguagem-âncora do Cauã (Pythia), mas com filosofia OPOSTA (decisão do líder 2026-07-18, ponto 2). Pro Cauã, Pythia é velocidade e impulso: roda rápido, perdoa o erro, conserta depois. Pra Jaci, Pythia é leitura e exatidão: perdoa o erro, mas pede pra você recontar antes de seguir em frente. A lição que ela herdou da avó Anciã Mariana ("contar é cuidar", `jaci-proxy.md` memória dos 6 anos) vira o eixo da versão dela da linguagem. Onde o Cauã diria "rodou errado, eu conserto depois", a Jaci diria "reconta, aprende, cuida", frase que ela repete baixinho pra si mesma como uma espécie de mantra técnico (ver §4).

Par de falas lado a lado pra marcar o contraste (não é banter entre os dois, é a mesma linguagem-âncora com duas filosofias, algo que o jogador percebe se ouvir os dois em sequência):

- CAUÃ (PT): "Pythia te abraça. Pythia perdoa o ponto-e-vírgula esquecido."
- CAUÃ (EN): "Pythia hugs you. Pythia forgives the forgotten semicolon."
- JACI (PT): "Pythia perdoa o erro." (pausa) "Mas Pythia também pede pra você recontar."
- JACI (EN): "Pythia forgives the mistake." (pause) "But Pythia also asks you to recount." (nota: "recount" carrega o duplo sentido contar-de-novo/relatar que "recontar" tem em português, tradução quase 1:1, sorte rara)

**Teste de voz única** (`party.md`): se uma fala da Jaci soa igualmente natural na boca do Cauã (rápida demais, sem o cuidado de recontar) ou do Gus (processada demais, sem calor humano), ela está errada, refazer.

### 2. Combate (calma clínica sob pressão)

Contraponto total ao Cauã (grita, avança primeiro, calor de linha de frente): a Jaci é a calma no centro do caos. **Nunca grita**; quando o perigo é maior, a voz dela fica MAIS baixa e MAIS lenta, nunca mais alta. Prioriza a ferida antes da emoção, avisa perigo com frieza técnica, dá comando curto que soa mais como diagnóstico do que como ordem. Pool de barks por momento, para o `narrative-writer` escolher/variar.

**Avaliar / abrir o jaleco**
- PT: "Deixa eu ver. Não se mexe." (ajoelha, olhos correndo o corpo do aliado, mão já no jaleco)
- EN: "Let me see. Don't move." (kneels, eyes scanning the ally's body, hand already reaching for her coat)

**Aplicar cura / bio-sutura**
- PT: "Segura a respiração. Isso fecha rápido." (pressiona a ampola contra o corte)
- EN: "Hold your breath. This closes fast." (presses the ampoule against the cut)
- PT: "Fica parado dois segundos. Só dois."
- EN: "Stay still for two seconds. Just two."

**Avisar perigo com frieza técnica**
- PT: "Segura. A hemorragia primeiro."
- EN: "Hold on. The bleeding first."
- PT: "Não respira fundo. Costela trincada."
- EN: "Don't breathe deep. Cracked rib."

**Comando calmo (emergência que vira ordem sem gritar)**
- PT: "Você, deita. Agora." (tom de diagnóstico, não de grito)
- EN: "You, lie down. Now." (delivered like a diagnosis, not a shout)

**Aliado em perigo (HP baixo)**
- PT: "Fica comigo. Conta comigo: dez, nove..." (voz baixa, ampola já na mão antes de terminar a frase)
- EN: "Stay with me. Count with me: ten, nine..." (low voice, ampoule already in hand before she finishes the sentence)

**Vitória**
- PT: "Ninguém sangrando demais. Boa contagem." (guarda as ampolas, confere de novo antes de deixar o sorriso aparecer)
- EN: "No one bleeding too much. Good count." (puts the ampoules away, checks again before letting herself smile)

**Tomar dano**
- PT: "Isso vai deixar marca." (pausa, sem parar de tratar o outro) "Depois eu cuido de mim."
- EN: "That's going to leave a mark." (pause, without stopping treatment on the other) "I'll deal with myself later."

**Recontagem pós-combate (o tic entra até no fim da luta)**
- PT: "Espera. Deixa eu contar de novo." (conta as ampolas restantes, memoriza o gasto)
- EN: "Wait. Let me count again." (counts the remaining ampoules, memorizes what was spent)

### 3. Interação com o Gus (o cuidado + o subtexto velado)

Não é banter de rivalidade como o Cauã; é aliança emocional. Jaci é, por canon (`jaci-proxy.md` §Interno), **a única companion que efetivamente cuida do Gus emocionalmente**, e faz isso sem verbalizar, via gestos.

#### 3.1 O cuidado (ação primeiro, frase rara, decisão do líder ponto 1)

O padrão é MIX: ela FAZ o cuidado (serve, empurra, ajeita) e, raramente, solta uma frase curta que gruda. Cuidado = verbo comum; frase = evento raro, guardado pros momentos que realmente pesam. Regra de uso: no máximo 1 a 2 frases-que-ficam por arco companion dela; se ela verbaliza toda hora, a frase perde a força.

- PT: (serve chá sem perguntar, põe na frente de quem está exausto) [sem fala]
- EN: (pours tea without asking, sets it down in front of whoever is exhausted) [no line]
- PT: (empurra uma ampola extra pro bolso de um aliado antes de uma missão perigosa, sem dizer nada)
- EN: (slips an extra ampoule into an ally's pocket before a dangerous mission, without a word)
- PT: "Toma." (só isso; a ampola já resolve o resto)
- EN: "Here." (that's it; the ampoule does the rest of the talking)
- PT: "Você cuida da gente." (pausa) "Mas você também precisa que cuidem de você." (pulled quote canônico, climax, `jaci-proxy.md`; raríssimo, guardado pro momento certo)
- EN: "You take care of us." (pause) "But you need someone to take care of you too."

#### 3.2 O subtexto platônico velado Jaci x Gus (recém-canonizado, regras ESTRITAS)

Canon: `party.md` §"Sem triângulos" + §"Não fazer" (exceção nuançada 2026-07-18). Regras herdadas, repetidas aqui pra fixar: nunca dito em voz alta por nenhum dos dois; aparece só em gesto, um emoji de carinha (ver §5), uma hesitação; nunca vira triângulo, declaração ou "arco romântico"; se um leigo perceber, foi longe demais. É a camada extra do "cuidar sem dizer", não um enredo.

**Exemplo A (rotina que vira gesto, chegada de missão pesada)**
- PT: (a Jaci já está com o chá pronto quando o Gus chega, antes mesmo dele abrir a boca) "Senta." (aponta a cadeira, não olha pra ele enquanto fala, olha pra chaleira)
- EN: (Jaci already has the tea ready when Gus arrives, before he even opens his mouth) "Sit." (points at the chair, doesn't look at him while she says it, looks at the kettle instead)
- *Nota de sutileza:* o não-olhar é o detalhe que carrega o subtexto; a fala em si é puro cuidado funcional, um leigo lê só isso.

**Exemplo B (perfeccionismo do Gus, intervenção clínica com camada dupla)**
- PT: (põe a mão no pulso dele, checando) "Seu pulso tá rápido demais pra quem só tá sentado lendo." (pausa) "Descansa." (solta a mão rápido, como se tivesse percebido que segurou por tempo demais)
- EN: "Your pulse is too fast for someone who's just sitting there reading." (pause) "Rest." (lets go quickly, as if she'd noticed she was holding on a beat too long)
- *Nota de sutileza:* a justificativa clínica é o disfarce (plausible deniability); o único tell é "um beat a mais" antes de soltar. Nada além disso.

**Exemplo C (vulnerabilidade rara do Gus, reação por ausência de comentário)**
- Contexto: beat canônico da reflexão pós-perda das sementes (`jaci-proxy.md` §Mini-quest pós-recrutamento), onde o Gus quebra parcialmente a frieza técnica dele.
- PT: (o Gus fala mais do que costuma; ela escuta até o fim sem interromper) (pausa longa) "Conta as ampolas comigo?" (muda de assunto, mas fica mais perto do que precisava ficar)
- EN: (Gus says more than he usually does; she listens all the way through without interrupting) (long pause) "Count the ampoules with me?" (changes the subject, but stays closer than she needed to)
- *Nota de sutileza:* ela não comenta o que ele disse, não retribui em palavras; o "mais perto do que precisava" é o único sinal, e cabe inteiro dentro de uma cena cuja função primária é outra (ele processando o luto das sementes).

**A linha que NÃO se cruza:**
- Nunca é dito em voz alta por nenhum dos dois, nem em pensamento narrado explicitamente como "amor" ou "gosto dele".
- O emoji de carinha (§5) só aparece em beat de ação, nunca substitui ou decora a fala como se fosse mensagem de texto.
- Nenhum toque além do já justificável clinicamente (pulso, testa, ombro de apoio). Sem mão dada fora de contexto de perigo/resgate, sem abraço que não seja de socorro, jamais beijo.
- Nenhum outro personagem comenta, percebe ou brinca sobre isso; isso mataria a sutileza e viraria "arco romântico" ou piada de shipping, violando `party.md`.
- Nenhuma cena "só os dois" com blocking romântico (golden hour, trilha subindo, câmera se aproximando). O momento sempre acontece dentro de uma cena cuja função primária é outra (curar, contar ampola, esperar o resto da party).
- O Gus nunca reage verbalmente além do já estabelecido no canon dele (pausa de 1s processando, no máximo).
- Regra de calibração: se ao reler a cena um leigo perguntaria "eles estão namorando?", cortar e reescrever mais frio.

### 4. Momentos pesados / a sobre-responsabilidade

Regra de voz: quando é hora pesada, ao contrário do Cauã (o bordão SOME, silêncio total), na Jaci o **tic de contar INTENSIFICA**. Ela perde a conta, repete o número errado, entra na espiral do off-by-one (canon `comic-reliefs/cena-09-off-by-one.md`). É o sintoma dela de sobrecarga: o nome técnico do problema aparece antes do nome emocional.

**Pulled quotes canônicos** (não reescrever, só usar; `jaci-proxy.md`):
- PT: "Faltou uma."
- EN: "One's missing."
- PT: "O que mexe na linfa, não o que mexe no sangue. São coisas diferentes."
- EN: "What moves in the lymph, not what moves in the blood. Those are different things."
- PT: (pós-perda sementes) "Eu sei. Eu também não consigo salvar tudo. Vou seguir tentando, com menos."
- EN: "I know. I can't save everything either. I'll keep trying, with less."

Sobre o wound dos pais (regra canônica: seed silente, NÃO dramatizar, `jaci-proxy.md` §Não fazer). Quando perguntada direto, Jaci ecoa quase literalmente as palavras que a própria Mariana usou com ela aos 3 anos (memória formativa canônica), sem chorar, sem discurso:

- PT: "O corpo deles parou de fazer o que precisa fazer." (pausa) "Eles tentaram. Não conseguiram. Eu sei a diferença." (não elabora)
- EN: "Their bodies stopped doing what they needed to do." (pause) "They tried. They couldn't. I know the difference." (doesn't elaborate)
- *Nota:* o eco quase literal da fala de Mariana é deliberado, mostra que a voz da Jaci foi herdada, não inventada, sem precisar narrar isso em texto.

Falas novas reutilizáveis, mesmo registro (sobrecarga sem drama):

- PT: "Eu contei errado." (pausa) "De novo."
- EN: "I miscounted." (pause) "Again."
- PT: "Reconta. Aprende. Cuida." (baixinho, só pra si, antes de recomeçar a contagem, o mantra do ponto 2)
- EN: "Recount. Learn. Care." (quietly, just to herself, before she starts the count over)
- PT: "Não dá pra salvar todo mundo." (pausa) "Dá pra não desistir de ninguém antes da hora."
- EN: "You can't save everyone." (pause) "You can refuse to give up on anyone before it's time." (nota: tradução literal da dupla-negação em português soa estranha em inglês; "refuse to give up" preserva o peso moral sem quebrar a cadência)

### 5. Registro científico + paleta de emojis-piloto (PROPOSTA, decisão nova do líder, aguarda confirmação)

**Registro científico** (padrão de fala, não gíria):

| Padrão pt-br | Uso | Equivalente en-intl | Nota |
|---|---|---|---|
| Refere doença por sintoma, não por nome | "o que mexe na linfa", "o que aperta o pulmão" | mesma construção: "what messes with the X", "what tightens the Y" | metáfora corporal concreta em vez de jargão médico formal; o inglês aceita a mesma sintaxe quase 1:1 |
| Nomes de plantas/botânica como comparação | referências à flora da Selve pra explicar processo biológico | manter nome próprio (canônico ou Sylvarin) sem tradução, ou equivalente natural em inglês se for planta genérica | nome próprio nunca traduz; planta genérica pode virar termo comum em inglês |
| "off-by-one" (tic, termo técnico) | jargão de programação já emprestado no pt-br do jogo (`comic-reliefs/cena-09-off-by-one.md`) | **off-by-one** (mesmo termo, sem tradução) | já é empréstimo do inglês mesmo na fala em pt-br; o termo É a piada, não force tradução |
| Contagem em voz alta como regulação (tic) | "dez, nove, oito..." | mesma contagem, números cardinais em inglês | não é gíria, é comportamento; funciona igual nas duas línguas |
| Cadência maternal apesar da idade | frases médias, sem gíria infantil, tom de quem já cuidou antes | registro formal-gentil em inglês, evitar contração excessiva | contraste deliberado com o registro solto e contraído do Cauã; Jaci pode usar "I am" cheio quando quer soar mais cuidadosa, não só "I'm" |

**Paleta de emojis-piloto** (decisão nova do líder, ponto 4; camada emocional NÃO-VERBAL, casa com "cuida sem dizer"; SÓ a Jaci por ora):

*Nível 1, cuidado geral (qualquer companion, contexto não-romântico, uso pouco mais frequente mas ainda raro):*
- 🌿 (folha): gesto de cuidado rotineiro e silencioso (ajeita bandagem, arruma ampola, cobre alguém com o jaleco). Aparece só quando o gesto NÃO tem fala associada, preenche o silêncio, não decora a fala.
- 😌 (rosto sereno): alívio clínico, "estabilizou", depois de uma cura bem-sucedida ou de confirmar que alguém está bem.

*Nível 2, subtexto Jaci x Gus (exclusivo, ultra-raro, é literalmente o "emoji de carinha" citado em `party.md`):*
- 🙂 (sorriso fechado, discreto): reservado pros momentos de §3.2. Regras de uso: (1) sempre emparelhado com um gesto de cuidado já em curso, nunca sozinho; (2) aparece no máximo 2 a 3 vezes na campanha inteira, a raridade É o peso; (3) nunca ao lado de coração, beijo, olhinho de coração ou piscadinha; (4) some 100% do tempo se houver qualquer outro personagem testemunhando o momento.

**Onde na UI (sugestão, líder decide):** anexado como beat de ação depois da fala/gesto, dentro da caixa de diálogo, do mesmo jeito que `(pausa)` já funciona na convenção do projeto (ex.: `"Toma." (🌿)`). Não decorar o retrato dela: expressão facial já é trabalho do `game-animator` (micro-expressão), não de emoji. Alternativa descartada: emoji flutuante sobre o retrato (tipo balão de reação), porque compete com o HUD e lê como "mensagem de texto", quebrando o tom mais literário do diálogo do jogo.

**Quando NÃO aparece:** em combate (a calma clínica não usa emoji, mantém o registro de comando do §2); em cenas com mais de 2 personagens presentes (risco de virar decorativo); em qualquer fala que já tenha uma frase-que-fica do §3.1 (a frase rara já carrega o peso sozinha, dobrar com emoji dilui).

**RISCO TÉCNICO obrigatório (líder, 2026-07-18): TOFU.** A fonte da UI é a PixelOperatorMono (Latin, motor próprio do glintfx, SEM fallback de fonte, ver `reference_fonte_ui_fallback`/`reference_terminal_glitch_fonte`); ela NÃO tem glifos de emoji. Inserir 🌿😌🙂 como caractere Unicode cru no texto do diálogo renderizaria TOFU (□). Portanto a implementação NÃO pode colocar o code-point de emoji direto na string user-facing. Duas trilhas viáveis (decisão técnica pendente antes de qualquer uso em produção): (a) estender a fonte com esses poucos glifos desenhados em pixel-art, casando com a pendência já existente FONT-EXTEND-GLITCH; ou (b) renderizar cada carinha como um SPRITE/ícone pixel-art inline (imagem no fluxo do diálogo, não caractere de texto), como um decorator. Este guia canoniza a INTENÇÃO (a camada emocional não-verbal), não o code-point Unicode literal. Item de backlog: EMOJI-JACI-FONTE.

### 6. Não fazer

- Não estética "menina sombria mística". Jaci é técnica, não onírica; heterocromia é prótese, não simbolismo (herdado de `jaci-proxy.md`).
- Não vampire vibe (pele alva é genética, não goth).
- Não maternal forçada: ela cuida porque sabe, não porque "menina sempre cuida" (herdado de `jaci-proxy.md`).
- Não morte-dos-pais dramatizada: trauma é seed silente, nunca centro de monólogo (herdado de `jaci-proxy.md`).
- Não deixar a filosofia de velocidade do Cauã vazar pra fala da Jaci: ela NUNCA diz "conserto depois", sempre reconta antes.
- Não gritar em combate, mesmo em emergência: contraste absoluto com o calor gritado do Cauã; a urgência dela sobe em precisão, nunca em volume.
- Não verbalizar o subtexto Jaci x Gus em NENHUMA circunstância (ver "linha que não se cruza", §3.2); na dúvida, cortar.
- Não deixar o emoji virar hábito de toda fala (poluição visual); a regra de raridade do §5 é rígida.
...
>
> **Cross-ref:** `characters/bento-requiem.md` (canon completo, wound/want/need/flaw, memórias formativas, pulled quotes), `characters/party.md` (matriz de linguagens-âncora, dinâmicas de conflito, exceção declarada Pillar 2), `characters/gus.md` (voice do Gus pro banter), `comic-reliefs/cena-01-sexta-feira-cinco-da-tarde.md` (Cena 1, "Sexta-feira, cinco da tarde", sinal do compilador), `comic-reliefs/cena-02-tabulacoes-vs-espacos.md` (Cena 2, "Tabulações vs Espaços", a guerra santa) e `comic-reliefs/cena-08-comentarios-em-latim.md` (Cena 8, "Comentários em Latim"), cenas canônicas usadas como matéria-prima, não reescritas aqui. `guia-dialogos.md` (formato: aspas, zero em dash, beat de ação em vez de tag com advérbio).
>
...
Bento tem 14 anos (o mais velho da party), é Tanque/Defensor de Área da Ordem Recursiva (Catedrais de Neo-Sylvania), linguagem-âncora **Asmódico** (analógico tradicional, exceção declarada do Pillar 2: engrenagens no lugar de cartas). Na superfície é a voz mais formal e mais lenta da party: frases longas com cláusulas subordinadas, vocabulário arcaizante em **pinceladas** (não constante), pausa deliberada antes de qualquer resposta que importe. Tic físico: **o sinal do compilador**, uma cruz traçada sobre o cronômetro mecânico no peito, reservado a momentos graves (`comic-reliefs/cena-01-sexta-feira-cinco-da-tarde.md`). Chama o Gus de "garoto", quase carinho disfarçado de formalidade.
...
**Eco do canon** (`comic-reliefs/cena-05-expressao-regular.md`, não reescrever, só ancorar aqui):
...
| "múmia" (Cena 5, `comic-reliefs/cena-05-expressao-regular.md`) | desprezo elegante pela verbosidade do C-Arcane | **mummy** | tradução literal preserva a imagem grotesca-cômica; alternativa descartada "corpse" (perde o humor seco, fica só macabro) |
...
*Nota de subtexto (não sublinhar em fala):* o sobrenome Neumann carrega, em surdina, o eco do análogo técnico von Neumann da linhagem Óxido; a Linda nunca comenta a própria etimologia, o peso fica só na autoria, nunca em diálogo.
...
#### 3.2 Nota secundária, o Gus (filosófico, Cena 6 `comic-reliefs/cena-06-bug-declarado-feature.md`)

Canon (`comic-reliefs/cena-06-bug-declarado-feature.md` "Bug declarado Feature", pulled quotes, **não reescrever**, só ancorar aqui): Linda capta rápido como a Sterling Corp distorce realidade via linguagem (declarar bug como "comportamento emergente inesperado"); o Gus reconhece o valor da leitura dela.
...
**Fontes da pesquisa (traços de crianças superdotadas):**
- [Davidson Academy, Gifted Student Characteristics](https://www.davidsonacademy.unr.edu/blog/gifted-student-characteristics/)
- [Perfectionism and Anxiety: A Paradox in Intellectual Giftedness (PMC)](https://pmc.ncbi.nlm.nih.gov/articles/PMC3408483/)
- [The Grayson School, Perfectionism in gifted students](https://thegraysonschool.org/news-resources/perfectionism-in-gifted-students/)
- [Teachers Institute, Key Traits of Gifted and Talented Children](https://teachers.institute/facilitating-growth-development/key-traits-gifted-talented-children/)
