...
| "off-by-one" (tic, termo técnico) | jargão de programação já emprestado no pt-br do jogo (`comic-reliefs.md` Cena 9) | **off-by-one** (mesmo termo, sem tradução) | já é empréstimo do inglês mesmo na fala em pt-br; o termo É a piada, não force tradução |
