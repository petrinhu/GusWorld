...
- **Goal aparente:** manter oficina independente na Periferia Industrial, longe da FIR.
- **Goal real (oculto):** servir Sterling Corp como operativo encoberto. Instalar rootkit progressivo no Gus via manutenções do aparelho ortodôntico. Espelhar telemetria para mainframe Sterling.
- **Aparência:** endomorfo atarracado, mãos superdimensionadas, indumentária industrial amarela com graxa, dedos modulares cibernéticos (mão esquerda), óculos de solda na testa. **Foreshadow visual escalonado:** ao longo do jogo, expressão facial torna-se progressivamente mais fria; manchas de graxa migram para mãos mais limpas (upgrade Sterling); óculos de solda na testa têm reflexo cyber-corporativo sutil no late game.
- **Voice:**
...
## Interno (esquema duplo)

### Camada aparente

- **Wound aparente:** viu cooperativas independentes da Periferia destruídas por Sterling Corp engenharia financeira. Trauma de infância.
- **Belief aparente:** "lealdade institucional mata. cada um por si."
- **Want aparente:** oficina independente próspera.
...
## Hero's Journey mini (subvertida)

Dante segue **a estrutura aparente**, mas cada beat é cobertura para a operação Sterling.
...
| **Retorno** | Junta-se à party. Torre Modular Anti-Aérea destravada. Manutenção gratuita do aparelho ortodôntico do Gus oferecida. | **Rootkit começa a ser instalado nesta manutenção.** |
...
## Cena de reveal (ato 3, climax)

Detalhes em `arco-principal.md` (Etapa 1 do climax).

- Entrada das Catedrais de Silício corrompidas. Dante se oferece pra hackear.
- Mid-hack, mão modular começa a operar em padrão Sterling reconhecível.
- [[patch-zero]] canal 1 faz entry em tempo real no Diário: `dante = vetor de injeção. cobertura confirmada.`
- Gus levanta o Tavus-Drive. Dante para. Vira-se. Sem culpa, sem raiva.
- **Linha Dante:** "Eu não pedi pra você confiar."
...
| Opção | Resultado |
|---|---|
| **Executar** | Rápido, melancólico. Dante cai. |
| **Capturar** | Incapacitado. Sterling sabotará à distância (morte off-screen ato 3 ou sobrevida em B.8 hook 3). |
| **Oferecer redenção forçada** | Mini-puzzle hacking. Sucesso = Dante volta como aliado pra fase 2 Sterling. Falha = morre. **Único caminho que destrava Ouro requer Knowledge alta + sucesso aqui.** |
...
- Não dar a Dante backstory de "ele foi enganado/forçado". É escolha cínica adulta em criança 13 anos. Tragédia.
- Não cena de catarse choro emocional Dante-Gus. Frieza permanece. (Pillar 4 contém.)
- Não morte heroica épica do Dante. Se morre, morre quieto.
- Não redenção verbal explícita. Se redime, é por ação, não por discurso.
- Não revelar a traição cedo demais. Foreshadow é planted; reveal é climax.
