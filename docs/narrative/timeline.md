...
| **Vanderbist (Pelicano Branco)** | Anhuera Vanderbist (~-95) → Soraia → Mariana (Anciã atual, **nasc -89, 89 anos canon Fibonacci ano 0, terminal**, ver [[CHARS]] §4) → Lia (morta -8) → Jaci | [[jaci-proxy]] |
