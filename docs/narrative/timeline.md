...
| **-0.5** | **Aldebrando Chevalier (pai de Bento) morre** na Catedral Menor de Atelaiá, durante Vigília restrita de doze mestres: exposição prolongada a interferência ressonante calibrada introduzida na câmara central. Aldebrando absorve o pico ressonante sustentando escudo cinético até que os demais mestres se retirem em segurança; onze sobrevivem, ele não. Eliminação atribuída a contrato Sterling Corp não verbalizado em fólio público (confirmada apenas a Bento e ao Mestre-Hierofante). Diário pessoal de Aldebrando preservado por Velhusto, entregue a Bento no início do jogo. **Bento tem 13.5 anos no momento da perda** (nasc -14, ano 0 = 14): wound recente, catalisador imediato do arco. | Wound recente Bento. Pai-figura ausente substituído por Velhusto. |
