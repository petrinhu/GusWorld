...
- **Contagem do catálogo:** esta espécie ainda não está somada à linha de abertura de §5 (que fala em 20 espécies, 5+6+6+3) nem à tabela de tensão numérica do limiar de 100 (`conquistas.md` §2.9). Os dois cálculos dependem de fraqueza e reencontrabilidade, que aqui seguem pendentes; a soma correta pede reaudição quando essas pendências fecharem.
