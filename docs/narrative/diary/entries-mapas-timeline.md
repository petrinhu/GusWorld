...
| 49 | -3 | **Sterling Corp localiza bug primordial Patch-Zero** em região profunda Núcleo Mandelbrot. Captura tentada via expedição armada. Falha inicial: 4 técnicos contaminados, isolados em ala hermética. Amostra parcial trazida ao Departamento de Contenção em GusWorld City. | Doc 14 confirma vetor 2 ([[lore-bible]] §8.2). | Vetor 2 Patch-Zero. | Mapa 8 (Núcleo Mandelbrot Externo/Interno). |
