...
| 56 | -0.5 | **Aldebrando Chevalier (pai Bento) morre** em incursão à catedral perdida. Causa oficial: queda em ruína. Causa real (entregue a Bento via Velhusto + diário): eliminado por descobrir interferência precoce Sterling em cripto-glifo profundo. Diário pessoal preservado por Velhusto, entregue a Bento no início do jogo. | Doc 9 ([[entries-docs-descobriveis|diário Aldebrando]]) destrava arco Bento. | Wound recente Bento. Pai-figura ausente substituído por Velhusto. | Mapa 3 (catedral perdida Knowledge Ouro). |
