...
>
> **Cross-ref imutáveis:** [[lore-bible]], [[timeline]], [[factions]], [[tradicoes-cultura]], [[in-world-docs]], [[pillars]] §Pillar 5.

---

## Princípio Bloco F

Pillar **mostre, não conte**. Lore não é dump expositivo de NPC; é vitral incrustado em prédio, é cripto-glifo coberto por cartaz Sterling, é cronômetro de latão batendo dentro de fonte pública 700 anos depois do último mestre que o programou. O setting **fala antes** do diálogo começar.

Cada doc segue template fixo (10 seções, padrão estável cross-settings). Player sente diferença entre settings por **camadas materiais cruzadas no tempo**, não por skin trocada.
...
- **Cross-era profundidade aplicada em todos 8 settings.** Cada doc tem §5 "Ruínas cross-era" obrigatória: vestígio Era 1 (Pré-Código / Neo-Sylvania) + Era 2 (Compilador) + Era 3 (Sterling). Player aprende a "ler camadas" do mundo conforme avança.
- **NPCs ambientais = tipos genéricos + 2-3 nomeados por setting.** Não infla [[factions]] (NPCs lore-importantes já catalogados lá). Os nomeados aqui são **NPCs de cenário** (vendedor, guarda, monge de manutenção, criança da rua) com 1 hook de diálogo cada. Função: textura social, não load narrativo.
...
- Lore-bible (3 eras): [[lore-bible]]
- Timeline cronológica: [[timeline]]
- Facções (NPCs lore-importantes): [[factions]]
- Tradições culturais (cumprimentos, comidas, festas): [[tradicoes-cultura]]
- Docs in-world descobríveis (Bloco G): [[in-world-docs]]
- Pillars (setting = arena mecânica): [[pillars]] §Pillar 5
- Arco principal (beats que ocorrem nos settings): [[arco-principal]]
