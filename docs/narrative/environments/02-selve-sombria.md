...
**Trilha dos Pioneiros (atravessa Orla a Pântano).** Caminho de terra batida marcado por **placas de latão Era 2 cravadas em árvores**. Cada placa: nome + ano + descrição curta da expedição que passou ("Anhuera Vanderbist + Iremar Berenger, -95, mapeamento de fungo de tronco-vermelho"; "Mestre Hugo Tirol + Mestra Lavínia Sevra, -42, decifragem cripto-glifo Norte 3"). Cinquenta placas em sequência irregular. Algumas com placa companheira: marcador menor adicionado depois ("alcançou Catedral Submersa, retorno", ou "não retornou").
*Primeira impressão:* árvore qualquer com placa de latão antiga parafusada na casca, nome ilegível pela oxidação, exigindo limpeza para ler.
*Gancho exploratório:* completar mapa das 50 placas destrava entry Diário substancial. Algumas placas estão em zonas Pântano profundo, exigindo travessia segura.

**Pântano de Markov.** Brejo, névoa que se move em pulsos calculáveis. Criaturas mudam estado (alerta / passivo / fuga) em transições probabilísticas observáveis. Cadeia de Markov funcional: se você lê o estado anterior do bicho, você prevê o próximo. Bioluminescência aqui em tons azul-violeta (frequência mais baixa do que Orla). Pés afundam, água preta brilha quando perturbada.
...
**Bordas do Núcleo Mandelbrot.** Mais profundo. Geometria começa a sair do euclidiano de modo sutil. Distâncias parecem corretas mas não somam. Trilha que deveria ser reta curva sem que você perceba o curvar. Bioluminescência aqui vira branco-puro (não verde, não azul). Não está infectada pelo GRE; o efeito é **natural**. É o substrato Era 1 fazendo o que sempre fez. Pillar 2: caos genuíno irredutível começa aqui.
*Primeira impressão:* árvore que se mostra inteira de quatro ângulos diferentes ao mesmo tempo e você não consegue lembrar como ela é quando vira de costas.
*Gancho exploratório:* gate de Knowledge alta (climax-âncora Patch-Zero). Não traversal antes de ato 3.

## 3. Props narrativos (15)

| Prop | Onde | O que conta |
|---|---|---|
| Cripto-glifo Era 1 em rocha de margem | Orla Recursiva, primeira clareira | Linguagem da floresta gravada em pedra. Decifrável tardio. |
| Placa de latão Era 2 parafusada em casca de árvore | Trilha dos Pioneiros, ramos vários | Nome + ano + expedição. Mapeamento humano da Selve, herança Era 2. |
| Placa companheira menor "não retornou" | algumas placas Trilha dos Pioneiros | Custo da exploração. Tragédia sem catarse. |
| Fungo de tronco-vermelho | Orla e Pântano | Conta tempo em pulsações. Pelicano Branco lê ([[in-world-docs]] doc 7 fragmento 11). |
...
| Faixa de placeholder cinza em copa de árvore | Anomalia GRE interior | Mesh popping diegético. Selve sendo deletada. Não é bug do jogo. |
| Pichação Sterling Corp "Bem-vindo ao GRE" em rocha | Borda anomalia | Cínico. Texto holográfico que pisca sob chuva. |
| Cronômetro de latão Era 2 deixado para trás em galho | Trilha dos Pioneiros, ponto profundo | Mestre Asmódico passou aqui. Não sabemos quem. |
| Pulsação branca rítmica entre folhas | Bordas Núcleo Mandelbrot | Caos irredutível pulsa. Patch-Zero ancestral. Não responde a scan. |
...
- Estalo grave de ramo que cai em árvore de copa fractal (cadência calculável a partir do fungo de tronco-vermelho).

## 5. Ruínas cross-era (3 eras)

- **Era 1 (Pré-Código / Neo-Sylvania):** cripto-glifos em rocha de margem (Orla, Pântano profundo), gravados há aproximadamente 800 a 1100 anos. Câmaras herméticas de pedra contendo sementes-relíquia, ainda viáveis. Catedrais Neo-Sylvania sobreviventes dentro da Selve (cinco; duas controladas Ordem Recursiva, uma saqueada Sterling -3, duas perdidas; [[lore-bible]] §6.3 + [[03-catedrais-neo-sylvania.md|setting 03]]). Bioluminescência da Selve em si é vestígio funcional da Era 1: substrato programado por mestres antigos que ainda roda sem manutenção humana.

- **Era 2 (Era do Compilador):** Trilha dos Pioneiros com suas 50 placas de latão. Pegadas Era 2 ainda visíveis em pontos onde o solo argiloso preservou. Cronômetros mecânicos Era 2 abandonados em pontos pontuais (mestres Asmódicos que não voltaram; Ordem Recursiva mantém lista por respeito). Vilarejo do Pelicano Branco fundado em -45 usa Selve como casa.
...
**Tipos genéricos:** caçador-coletor Pelicano Branco (em trânsito de aldeia para Selve, vestido em algodão verde-marrom, sandália trançada, leva cesto); mestre Asmódico em expedição cartográfica (vestes formais Ordem Recursiva manchadas de barro, cronômetro de bolso no peito, anota em caderneta); técnico Sterling Corp em extração (uniforme cromado-cinza, sensores acoplados, dois drones de apoio); operador FIR de coleta forçada (uniforme amarelo-industrial, ferramentas brutas, geralmente em dupla); fauna não-hostil parada observando.
...
- **Para GusWorld City ([[01-cidade-cyber-gotica.md|setting 01]]):** entrada canônica pelo Anel Verde. Caminhões FIR atravessam carregando coleta forçada. Folha biolúmen no para-choque sinaliza retorno. Cidade visível de pontos altos da Orla Recursiva como skyline distante.
- **Para Catedrais Neo-Sylvania ([[03-catedrais-neo-sylvania.md|setting 03]]):** catedrais estão dentro da Selve (não na cidade; [[lore-bible]] §6.3). Trilha dos Pioneiros leva a duas das cinco ativas. Catedral Submersa no Pântano de Markov; Catedral Menor de Atelaiá borda Norte da Orla.
- **Para Selve Profunda ([[08-selve-profunda.md|setting 08]]):** Selve Profunda (vilarejo Pelicano Branco + Núcleo Mandelbrot interior) é continuação geográfica deste setting. Cruzar Pântano de Markov gateway natural. Tatauín Branca atravessa regularmente.
- **Para Zona do Silêncio ([[07-zona-do-silencio.md|setting 07]]):** rádio analógica Underground capta padrão Selve em frequências baixas ocasionalmente. Linda decifra. Selve "fala" indiretamente via rádio Pelicano Branco com Underground.
- **Para Catedral perdida ([[in-world-docs]] doc 15):** gate Ouro. Localização não-revelada em mapa; requer expedição conjunta arco Bento + Knowledge alta. Geograficamente em ponto profundo da Selve, perto do Núcleo Mandelbrot.
...
- **Convivência, não substituição:** os zumbis convivem com a fauna de estado observável e o boss-vírus já existentes no Pântano, não os substituem.
- **Combate (decisão do líder 31/08/2026, sem mudança):** dano normal derruba os zumbis, mas eles levantam de novo, o loop reinicia. Só ficam caídos ao receber um efeito que quebra o loop. A carta do Gödel ("Sentença Indecidível", 1×/batalha, ignora a próxima imunidade/resistência/bloqueio) é o trunfo pontual para um caso difícil, não a regra geral. **O efeito de interrupção que encerra o loop é a regra geral, desenhada em 05/09/2026 (item `G28` do `TODO.md`):** o status `SigKill`, aplicado por uma carta COMUM nova de família Sônico (nome de trabalho "Eco de Encerramento", `ChargeCost` 3, alvo único), que converte a próxima queda a HP 0 do alvo marcado em morte real em vez de reanimação, dentro de uma janela de turnos. Detalhe completo em `docs/design/mecanicas/cartas-technomagik.md` §5.7.
- **Vida ao reanimar, PROPOSTA pendente de confirmação do líder (revisão adversarial 05/09/2026):** nem aqui, nem em `cartas-technomagik.md` §5.7, estava dito com quanto HP o zumbi volta a ficar de pé, e sem esse número não dá pra calcular o preço de limpar a área. Com HP cheio, cada zumbi custaria a marca de `SigKill` MAIS uma barra inteira de dano dentro da janela; com HP residual, a marca já é quase todo o custo. **Proposta:** o zumbi reanima com uma fração fixa do HP máximo (25%, faixa aceitável 20-30%, calibrável em playtest), nunca com o HP cheio de novo, coerente com a fauna do resto do Pântano de Markov, cuja identidade é degradar em padrão observável (§1, §7 deste documento), não regenerar de vez. Isso torna o zumbi sempre derrotável por completo mesmo sem `SigKill` (1 golpe cheio pra derrubar a primeira vez, mais 1-2 golpes pequenos de limpeza a cada reanimação seguinte, nunca um loop infinito), e ainda deixa o `SigKill` claramente mais rápido, porque poupa os golpes de limpeza e resolve na primeira queda dentro da janela. Alternativa descartada nesta proposta: HP cheio a cada reanimação, que tornaria o zumbi efetivamente infinito sem `SigKill`, uma dependência de carta única pra progresso que o projeto evita por princípio de balanceamento (sem estratégia obrigatória, sem vala da morte). Decisão final do líder.
- **Caminho do trunfo Gödel, reporto que exige decisão do líder, não resolvo aqui (revisão adversarial 05/09/2026):** o efeito de Gödel ("Sentença Indecidível"/`NullProof`, `cartas-technomagik.md` §2.3/§6) age sobre o MULTIPLICADOR DE DANO (força `multFraqueza = 1.0` contra Resistente/Imune); o `SigKill` age sobre o DESFECHO DA QUEDA (impede a reanimação), não sobre dano. Hoje nada liga os dois: o `SigKill` funciona contra qualquer inimigo da área independente de resistência, então não sobra nenhum caso em que o trunfo do Gödel seja necessário pra resolver um zumbi; a frase "trunfo pontual para um caso difícil" descreve uma intenção que a mecânica atual não cumpre. **Caminho possível, proposto e não decidido:** dar a alguma variante mais dura do zumbi (um zumbi-elite do Pântano, ou o boss-vírus turn-based já citado em §7) Resistência ou Imunidade a uma das famílias que a party mais usa contra ela, de forma que, sem o Gödel, o golpe final dentro da janela do `SigKill` saia reduzido ou até anulado (podendo estourar a janela sem derrubar o HP a 0); só com o Gödel o golpe passa inteiro e a marca resolve no alvo certo. Isso é dar dado novo a um inimigo (Resistência/Imunidade específica), decisão de conteúdo que cabe ao líder, não a este agente.
- **Loot (sem mudança):** cada zumbi carrega algo que a rotina travada deveria ter devolvido ao mundo e ficou preso nele. **A lista concreta ainda não foi decidida:** ver `TODO.md` item `G29`.
- **Nome próprio:** sem objeto. O lugar já se chama Pântano de Markov; não há sub-local novo para nomear.

---

**Última revisão:** 2026-05-15. Canônico (Bloco F). Atualizações exigem aprovação do criador supremo. **Exceção pontual:** §11 acrescentado em 31/08/2026 por autorização expressa do líder, corrigido no mesmo dia após a leitura errada de "sub-local novo" ser identificada.
