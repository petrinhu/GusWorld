...
|---|---|---|---|---|---|---|---|
| F001 | Cena 4 `comic-reliefs/cena-04-force-push.md` "Force Push": Dante despreza histórico em manutenção do ortodôntico | Reveal Dante traidor (climax Etapa 1) | DAN | Dante / Gus | n/a (auto-trigger 50%) | GRAVADO | `comic-reliefs/cena-04-force-push.md` |
...
| F031 | Janelarum trava periodicamente (cena 11 `comic-reliefs/cena-11-janelarum-travou-de-novo.md`) | Apex-Data caiu de modo similar: engenharia de colapso Sterling | STE / E3 | Sterling | Knowledge baixa (cena cômica explícita) | GRAVADO | `comic-reliefs/cena-11-janelarum-travou-de-novo.md`, `arco-principal.md:369` |
| F032 | Cena 6 `comic-reliefs/cena-06-bug-declarado-feature.md` "Bug declarado feature": propaganda Sterling | Theme: inteligência serve a si mesma, distorce via linguagem | STE | Sterling / Gus / Linda | n/a (explícito) | GRAVADO | `comic-reliefs/cena-06-bug-declarado-feature.md` |
...
| F068 | Tomo da Pilha Sobrecarregada em sebo aberto na Praça do Compilador | Documentação coletiva Era 2 continua aberta; conhecimento ainda compartilhado apesar de Sterling | E2 | Cauã / Gus | n/a (cena 7 `comic-reliefs/cena-07-tomo-da-pilha-sobrecarregada.md`) | GRAVADO | `environments/06-periferia.md:129`, `comic-reliefs/cena-07-tomo-da-pilha-sobrecarregada.md` + folheto encartado `in-world-docs.md` §18 (DD-018 folheto Lin Tórun) |
| F069 | Engrenagem-mestre de dentes em razão recorrente, 950 anos, no altar da Catedral Principal | Pillar 2 ao vivo: state machine analógica Era 1 ainda operacional; substrato durável | E1 / E2 | Bento | n/a (visual) | GRAVADO | `environments/03-catedrais-neo-sylvania.md:67` |
| F070 | Pátio do Cronômetro-Hilário: cronômetro de bolso quebrado, ponteiros parados às 14:37, placa de latão | Wound canônico Bento aos 7 anos (Hilário morto em -7); environmental storytelling silente | COM-BEN / E2 | Bento / Hilário | n/a (visual) | GRAVADO | `environments/03-catedrais-neo-sylvania.md:46-51`, `characters/bento-requiem.md:99` |
...
| F103 | Cena pública: "Linda, você está pensando como Sterling." / "Que horror." (cena 6 `comic-reliefs/cena-06-bug-declarado-feature.md`) | Linda reconhece manipulação linguística Sterling; theme afirmado | COM-LIN / STE / theme | Linda | n/a | GRAVADO | `comic-reliefs/cena-06-bug-declarado-feature.md` |
...
| F117 | "Bento se preocupa demais com tradição" (Dante, passing comment, cena 4) | Dante despreza tradição publicamente: coloca-se como anti-Asmódico antes do reveal | DAN | Dante / Bento | n/a (cena cômica) | GRAVADO | `comic-reliefs/cena-04-force-push.md`, `characters/dante-grid.md:133` |
...
| F121 | Espiral logarítmica sobre folha estilizada bordada em mantos Pelicano Branco | Símbolo Selve canônico; tradição matemática viva | E1 / COM-JAC | Pelicano Branco / Jaci | n/a (visual) | GRAVADO | `factions.md:371`, `environments/08-selve-profunda.md:66` |
...
| F123 | Janelarum 2.0 absorvido por Sterling em -10 (era plataforma independente até então) | Padrão de absorção corporativa; cidadania trocou conveniência por captura | E3 / STE | Sterling | n/a | GRAVADO | `timeline.md:117`, `comic-reliefs/cena-11-janelarum-travou-de-novo.md` |
...
Wound canônico: morte de Hilário Tepenkov em -7 na Catedral Menor de Atelaiá quando Bento tinha 7 anos. Plants: F070 (Pátio do Cronômetro-Hilário, environmental storytelling silente), F055 (doc 3 diário Atelaiá Chevalier descrevendo padrão similar em -80, eco direto). Padrão: "estávamos em treze. saímos em quatro" (Atelaiá) ↔ "13 mestres no incidente original / 4 sobreviventes / Bento aos 7 anos sobrevive" (Hilário em -7). Linhagem de horror Neo-Sylvania → Catedral Menor de Atelaiá → Bento.
...
**Era 2 (Era do Compilador)** plants: placa de latão "À PRIMEIRA LINHA QUE COMPILOU, OBRIGADO" (F067), Tomo da Pilha Sobrecarregada em sebo público (F068), trilha de latão dos pioneiros (F066), engrenagem-mestre de dentes em razão recorrente da Catedral (F069), oficinas Era 2 cooperativas C-Arcane (F107), pichação "AINDA SOMOS NÓS" (F107), Última Frequência (F087), partituras Era 2 no anexo Underground (F088 contextual), parceria fundadora Berenger-Vanderbist em -95 (Selve), música Era 2 vs música Sterling Sigma (F034 contraste).
...
- **F068 (Tomo da Pilha Sobrecarregada em sebo).** Cena 7 `comic-reliefs/cena-07-tomo-da-pilha-sobrecarregada.md` paga a referência cultural. Mas não há payoff narrativo direto (player não destrava nada via consulta ao Tomo). Recomendação: deixar como ambient cultural reforçando theme Era 2 cooperativa. Não cortar.
