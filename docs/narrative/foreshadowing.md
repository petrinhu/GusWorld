...
| F083 | Adila guarda rancor paradoxal pela mãe Sonja (forçada a "retiro espiritual" em -6, morta -5) | Adila não menciona Sonja, evita o nome — culpa internalizada | COM-IAR / E3 | Adila / Sonja | Knowledge alta | GRAVADO | `factions.md:504`, `timeline.md:123` |
...
| F085 | Padrinho Tiago era conhecido de Bartolo Penkin (engenheiro QA Apex-Data desaparecido em -16) | Cross-arco Linda-Periferia: Underground preservou doc 5 por afeto | COM-LIN / STE | Tiago / Bartolo | Knowledge alta | GRAVADO | `in-world-docs.md:223`, `lore-bible.md:565` |
