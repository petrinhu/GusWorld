...
**A régua entre "vira prosa" e "vira sistema" é CASO A CASO, não uma lei geral (registrado em 2026-08-04, para ninguém "corrigir" depois).** A escada de 8 degraus (Q3) ficou decidida como só prosa: nada de medidor de paciência, nada de estado numérico derivado dela, porque ela **perde** ao virar número. Mas duas outras respostas do líder, na mesma leva de perguntas, foram o oposto: insistir num assunto imposto ao Gus (Q5) passou a fazer um NPC perder afinidade e mudar de estado de diálogo, e o "eu avisei" (Q6) passou a ser escolha do jogador (ouvir ou ignorar o aviso), com consequência distinta e reconhecimento de mérito quando ouvido a tempo. **As três respostas não se contradizem.** A régua não é "personalidade do Gus não vira sistema"; é que a afinidade e a escolha do aviso são **decisões do jogador**, e decisão do jogador é justamente o que merece sistema, enquanto a escada é textura de cena que só existe para ser lida em prosa. Ao decidir se um traço novo do Gus vira mecânica, perguntar: isto é o jogador escolhendo algo, ou é o personagem sendo descrito? Detalhe completo das quatro perguntas (Q4 a Q7): `docs/narrative/PERGUNTAS-CANON-GUS-AHSD-2026-08-01.md`. **O desenho de como a afinidade/escolha funcionam é de outra alçada** (`lead-game-designer` + aprovação do líder), não deste guia.
