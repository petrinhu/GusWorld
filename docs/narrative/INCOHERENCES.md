...
- **C14. Série `roster-analogos/`: "4 Famílias-Pilastra" vs canon "8" (drift sistêmico dos design docs). [ABERTO 2026-07-11]** O canon fixa **OITO** Famílias-Pilastra (`docs/narrative/deep/eras/era-2-boom-tecnico.md` §7, selado "não modificar sem criador"; `docs/book/BIBLE-V1-PREFACIO.md:52`). Mas os design docs (status PROPOSTA) da série de análogos dizem "**4** Famílias-Pilastra": `docs/design/roster-analogos/01-faraday.md:28`, `02-maxwell.md:11`, `03-tesla.md:16`, `07-planck.md:26`, `10-godel.md:26`, `11-ada-lovelace.md:24`, `12-turing.md:26`, `16-pythagoras.md:28`, `19-menger.md:26`, `20-bastiat.md:27`. Drift herdado (design docs escritos/revisados ~2026-07-08, depois da consolidação R10 do Era 2 que fixou 8, sem cross-check). Achado pelo `revisor-textual` ao auditar a prosa deep-lore do Faraday (que materializou o "4" e **foi corrigida para "8"** em `mestre-elm-01-faraday.md`). **Pendente:** limpeza em lote dos ~10 design docs `roster-analogos/` (4→8), decisão do criador (canon vigente, orquestrador não edita sozinho). A prosa deep-lore nova (`mestre-*.md`) já usa "8" corretamente daqui pra frente.
...
**C20. Morte de Aldebrando Chevalier (pai do Bento): "catedral perdida / queda em ruína" vs deep-lore. RESOLVIDO 2026-07-08. Retrofit de prosa FECHADO 2026-07-08.**
`timeline.md:140`, `lore-bible.md:511` e `factions.md:128` descreviam a morte de Aldebrando com uma causa oficial genérica ("incursão à catedral perdida... causa oficial: queda em ruína") que não batia com o deep-lore de detalhe. Canon fechado (decisão do criador, D2 em `docs/auditoria/AUDIT-LORE-2026-07-08/DECISOES-CRIADOR.md`), com **fusão** das duas versões que circulavam no corpus: **local = Catedral Menor de Atelaiá, durante Vigília restrita de 12 mestres (onze sobreviveram, Aldebrando não); culpa = Sterling Corp**, que introduziu a interferência ressonante calibrada para silenciá-lo depois que ele descobriu, em cripto-glifo Era 1 profundo que copiava, o rastro precoce da corporação; **registro oficial** continua sendo "queda em ruína"; o **diário de Aldebrando sobrevive**, é entregue a Bento via Velhusto, e mais tarde ajuda a localizar a "catedral perdida" da expedição do arco Bento (evento separado e posterior, não confundir com o local da morte).

**Distinção importante:** "catedral perdida" aparece em dois sentidos no corpus. (A) A MORTE de Aldebrando, agora fixada como Catedral Menor de Atelaiá (não mais "catedral perdida"). (B) A EXPEDIÇÃO gate-Ouro do arco Bento, que Bento e Gus exploram durante o jogo, local diferente, revelado pelo diário; esse sentido (B) permanece intocado (ex.: `ordem-recursiva.md:51`, `characters/bento-requiem.md`, `deep/characters/bento-requiem.md`, `in-world-docs.md:635`, `environments/02` e `03`, `lore-bible.md:550`, `factions.md:200`, `diary/entries-docs-descobriveis.md`, `foreshadowing.md:90/244`, `patch-zero-deep.md:9`, `entries-manuscrito-glossario.md:348` e o título de MG-018 em `entries-manuscrito-glossario.md:65`).

**Retrofit prosa executado** (sentido A, morte): `docs/narrative/timeline.md:140`, `docs/narrative/lore-bible.md:511`, `docs/narrative/factions.md:128` (redação reforçada para deixar explícita a fusão); `docs/narrative/deep/eras/era-3-sterling.md:21,87`; `docs/narrative/diary/entries-fichas-bestiary.md:154`; `docs/narrative/diary/entries-mapas-timeline.md:536` (+ marcador de mapa `:167` desconflacionado do local da morte, mantido como gate-Ouro sentido B); `docs/narrative/diary/entries-manuscrito-glossario.md:65` (MG-018, resumo da entrada, título preservado como expedição); `docs/narrative/deep/factions/sterling-corp.md:93`. Snapshots derivados: `docs/book/BIBLE-V1-GLOSSARIO.md:13`, `docs/book/BIBLE-V1-INDICE.md:59,415`, `docs/book/BIBLE-V2-INDICE.md:207`. **Status:** RESOLVIDO, retrofit COMPLETO.

**Dominó relacionado, D1 (Salviano Alencar, causa mortis oficial = insuficiência cardíaca), também fechado nesta passada:** `docs/book/BIBLE-V1-GLOSSARIO.md:435`, `docs/book/BIBLE-V1-INDICE.md:61,393`, `docs/book/BIBLE-V2-INDICE.md:206` (retrofitados de "overdose/acidente" para "insuficiência cardíaca").
