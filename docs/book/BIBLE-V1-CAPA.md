...
Bloco de título centralizado no terço superior da capa, sobreposto à aurora mas acima da Catedral-Mãe.

Linha 1: "GUSWORLD" em sans-serif geométrica bold (família Inter ou Helvetica Bold), cor cyan claro #4FC3F7, tracking aberto, corpo dominante (cerca de 96pt em formato físico final).

Linha 2: "BÍBLIA WORLDBUILDING" em sans-serif regular, cor branco-quebrado, tracking médio, corpo médio (cerca de 36pt).

Linha 3: "VOLUME 1 · TOMO 1" em sans-serif light, cor cinza-azulado, corpo pequeno (cerca de 24pt). Separador visual ponto médio (interpunct) entre numeração de volume e tomo; artista pode alternar para losango pequeno ou pequeno selo Glyph-vyr decorativo se necessidade gráfica exigir.

Subtítulo abaixo do bloco, em itálico serif (família Garamond Italic ou Caslon Italic), cor branco-quebrado, corpo 18pt: "Frontispício, Cosmologia e Era 1 Pré-Código".

### Autoria

No terço inferior, acima do nome de Gus se essa região estiver visualmente ocupada, ou no rodapé caso contrário: "Criador supremo: Petrus." Sans-serif light, corpo 14pt, cinza-azulado discreto.
...
Cyan analítico (#4FC3F7 a #1A5C7A): 25 por cento. Vermelho carmesim Dragon (#8B1A1A a #E63946): 25 por cento, agora dominante e ativo, não fantasmagórico. Brass corporativo Sterling (#B8860B a #8B6914): 20 por cento, novo neste tomo. Preto urbano profundo (#050505 a #1A1A1A): 25 por cento. Verde-bio Jaci aparece em acento mínimo (#3E8E41) cerca de 3 por cento. Acentos das demais cores party totalizam 2 por cento.

### Tipografia título

Estrutura idêntica ao Tomo 1 para coerência cross-tomo.

Linha 1: "GUSWORLD" idêntica ao Tomo 1.

Linha 2: "BÍBLIA WORLDBUILDING" idêntica.

Linha 3: "VOLUME 1 · TOMO 2" idêntica em estrutura ao Tomo 1.

Subtítulo: "Eras 2 e 3, Magia, Personagens, Settings, Facções, Antagonistas e Apêndices" em itálico serif, corpo 18pt. Subtítulo é mais longo que Tomo 1 por necessidade de cobertura; artista pode quebrar em duas linhas se necessário.
...
Topo da lombada: "GUSWORLD" em sans-serif bold cyan claro, corpo 24pt.

Meio da lombada: "BÍBLIA WORLDBUILDING VOL. 1 · TOMO 1" em sans-serif regular branco-quebrado, corpo 14pt.

Base da lombada (não rotacionada, leitura horizontal quando livro está em pé na estante): selo Glyph-vyr discreto em hot stamping cyan, diâmetro 1.5cm.

Fundo da lombada Tomo 1: gradiente vertical do cyan profundo (#1A5C7A) no topo para preto puro na base, simbolizando descida cronológica de Era 3 para Era 1 quando o leitor "lê de cima para baixo" o tempo do worldbuilding.

### Tomo 2

Estrutura idêntica ao Tomo 1 para coerência visual quando os dois tomos estão lado a lado na estante.

Diferenças:

Texto meio da lombada: "BÍBLIA WORLDBUILDING VOL. 1 · TOMO 2".

Fundo da lombada Tomo 2: gradiente vertical do vermelho carmesim profundo (#8B1A1A) no topo para preto puro na base. Tomo 1 (gradient cyan) e Tomo 2 (gradient vermelho) lado a lado na estante formam dualidade pillar 5 setting bipartido.
...
'Quem ler isto vai ler mal. O leitor correto chega depois.' (Verônica Atelaiá, cronista heterodoxa, ano -45 do Código.)

Volume 2 Antologia narrativa, publicado em paralelo, traduz este worldbuilding em ficção cronologicamente organizada."
...
'O dragão que dorme em sangue ancestral acorda quando a criança perdoa antes de vingar.' (anônimo, Cordão dos Pelicanos.)"
...
Linha 1: "GUSWORLD" sans-serif bold corpo 72pt cyan.

Espaço.

Linha 2: "Bíblia Worldbuilding" sans-serif regular corpo 36pt branco-quebrado.

Linha 3: "Volume 1, Tomo 1" sans-serif light corpo 24pt cinza.

Espaço.

Linha 4: "Frontispício, Cosmologia, Era 1 Pré-Código" itálico serif corpo 18pt.

Espaço maior.

Linha 5: "Criador supremo Petrus." sans-serif light corpo 14pt.

Linha 6: "Edições Glyph-vyr, GusWorld City." sans-serif light corpo 12pt.

Linha 7: "Primeira edição, 2026." sans-serif light corpo 12pt.

Verso da folha de rosto (página esquerda seguinte): ficha catalográfica, copyright, créditos editoriais, créditos de revisão, agradecimentos breves.

### Tomo 2

Idêntico estruturalmente. Substituições: "Volume 1, Tomo 2" e subtítulo "Eras 2 e 3, Magia, Personagens, Settings, Facções, Antagonistas e Apêndices".

## 6. Diretrizes técnicas

Formato físico recomendado: 17 por 24 centímetros, formato royal ou large trade brasileiro. Proporção próxima ao golden ratio (1:1.41 vs golden 1:1.618), tolerável e amplamente comercial.

Papel miolo: 50 a 65 gsm bíblia semi-opaco offset. Justificativa: tomo de 1100 a 1155 páginas exige gramatura baixa para evitar peso superior a 1.2kg por tomo. Semi-opaco minimiza vazamento de tinta página-a-página em texto denso.
...
Tipografia corpo: serif clássica família Garamond Premier Pro ou Adobe Caslon Pro, corpo 10 a 11pt, entrelinha 14pt, justificada com hifenização pt-br ativa.

Tipografia títulos seção: sans-serif geométrica Inter Bold ou Helvetica Neue Bold, corpo escalonado 14, 18, 24, 36pt conforme hierarquia.

Tipografia citações canônicas: itálico serif Garamond Italic, corpo 11pt, recuo lateral 2cm ambos lados.

Cabeçalho de página par: nome do capítulo em sans-serif light corpo 9pt, alinhado à esquerda.

Cabeçalho de página ímpar: subtítulo da seção em sans-serif light corpo 9pt, alinhado à direita.

Rodapé: numeração arábica centralizada sans-serif corpo 10pt. Canon Glyph-vyr ornamento mínimo 3mm à esquerda da numeração apenas em páginas de abertura de capítulo.

## 7. Coerência cross-Volume

Volume 1 Bíblia Worldbuilding e Volume 2 Antologia narrativa formam dupla coesa do mesmo projeto editorial. Diretrizes para preservar coerência visual quando o artista desenhar o Volume 2 separadamente:

Paleta canônica do projeto permanece estável nos três livros (Volume 1 Tomo 1, Volume 1 Tomo 2, Volume 2 Antologia): cyan analítico, vermelho carmesim, brass corporativo, preto-tesselado. Volume 2 pode reorganizar pesos relativos conforme seu tom narrativo predominante, mas não introduz cor nova fora dessa paleta. Verde-bio e tons de acento de party seguem permitidos como em Tomo 2.

Logo "GUSWORLD" sans-serif geométrica bold cyan é idêntico nos três volumes, sem variação. Tipografia secundária pode adaptar-se conforme conteúdo.
