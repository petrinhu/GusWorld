...
- antologia/13-veronica-atelaia (master benchmark)
- antologia/14-heliaco-vyr-era-1 (Boca-da-Funda + 47ª prop + 3-5-7 + Helíaco canon)

## MATRIZ CUSTÓDIA §7 v2 — 9/10 OK

✅ Tomo Pilha Sobrecarregada (89 cópias originais → Atelaiá → Famílias-Pilastra + Ordem)
✅ Cordão 89 nós (Era 2 ~-120 → Mestres Ordem)
✅ Cripto-glifo grade 3×3 (Era 1 ~-1100 → Asmódico moderno → Underground)
✅ Boca-da-Funda (Era 1 Catedral-Mãe submerso -750)
✅ Diário Aldebrando (Velhusto → Bento)
✅ Selo Rosa Recursiva + Placa Pelicano Sacrificial + Placa Melancolia Recursiva + Placa Kryptos
❌ **Cronômetro mestre destravado** (GAP CANON — não encontrado era-2-boom-tecnico)
