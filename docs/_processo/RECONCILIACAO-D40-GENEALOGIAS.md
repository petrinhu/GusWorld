...
| 2. Sucessão matrilinear (cronistas Atelaiá) | `era-2-boom-tecnico.md`:1445 e :719 vs. `CHARS.md`:228 | cinco (pós-Atelaiá) vs. seis (incluindo Atelaiá) | Convenção, não erro — mas cruzam mal |
...
Nenhum dos quatro foi corrigido nesta rodada. **Achado 3 do briefing original ("linhagem do protagonista, já corrigida") foi reclassificado**: a busca não achou nenhuma correção já aplicada a uma linhagem de Gus Vector Tavus Vance (a cadeia Gustaf I-VII está consistente em "sete gerações" nas oito fontes verificadas nesta busca: `inicial.md`:16, `sinopse.md`:51, `docs/book/BIBLE-V1-CAPA.md`:127, `docs/book/BIBLE-V1-PREFACIO.md`:16, `docs/book/BIBLE-V1-STRUCTURE.md`:271, `docs/narrative/deep/characters/gus-dragon.md`:11, `docs/narrative/characters/gus-conto.md`:7 e `docs/narrative/deep/eras/transicoes-entre-eras.md`:183, nenhuma delas contradizendo as demais) nem a "oito nomes" concordando com glossário e índice em lugar nenhum do corpus. O achado que de fato bate com o padrão descrito ("diz um número dez vezes, lista outro") é a passagem da própria cronista sobre sua linhagem de sangue, em `capitulo-10...md`:1791, que **segue viva**, não corrigida. Isto é dito aqui explicitamente porque a premissa recebida não resistiu à verificação (L-18).
