...
| C-T4-011 | Patch-Zero | n/d | n/d | seção existe (`docs/narrative/characters/patch-zero.md`), conteúdo não relido linha a linha nesta rodada. **Sem verificação de vivacidade, só de existência** |
