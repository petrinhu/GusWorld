...
> **RESGATADO em 25/08/2026 do `gusworld_legacy`, com uma correção de regime.** O corpo abaixo diz que os assets são licenciados sob **CC-BY-SA 4.0**: isso está **superado** pela decisão do líder de 21/08/2026 (`GODS_LAWS.md` L-08) — hoje o regime é **todos os direitos reservados** (ver [`ASSETS-LICENSE.md`](../../ASSETS-LICENSE.md)), não copyleft. O que sobrevive intacto é o motivo de fundo do documento: para reservar todos os direitos sobre um asset, o líder também precisa ser o titular do copyright dele, e essa cadeia de titularidade (ferramenta de IA, data, tier de conta, base contratual no ToS) é exatamente o que a tabela abaixo registra. Onde o texto disser "base legal p/ CC-BY-SA", leia "base legal p/ titularidade do líder" — o fato registrado não muda, só a licença aplicada por cima. **Os caminhos e contagens abaixo são um retrato de 2026-07-12**; `resources/sprites/` já passou de 47 para 893 arquivos PNG nesta árvore (25/08/2026) e merece nova contagem antes de qualquer auditoria formal.
