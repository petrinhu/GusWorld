...
| **DA-2** | Lib/sistema de diálogo | O **blueprint de diálogo deste doc segue válido** (é dado de design agnóstico de engine); o runtime de diálogo será re-derivado em C++23 pelo squad técnico. |
