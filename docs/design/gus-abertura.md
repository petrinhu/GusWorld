...
- **NÃO nomear nem confirmar** o Dragon Victory, a linhagem Pyotor I Draco Vance, Vyrdragon, ou qualquer ramificação de origem (Transbordamento / `LORE-ORIGEM-MULTIVERSO`) nesta cena.
...
- **Gancho de conteúdo velado (opcional, barato):** a sequência correta de nós pode ser um número da escada numérica canônica do projeto, sem narrar.
...
- **Fragmento:** um caco pequeno dessa pedra-veio, com cripto-glifos gravados; vela o conjunto arquitetural-ritual do projeto (ashlar/cripto-glifo).
