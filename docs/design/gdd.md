...
- **Achievements, o corte foi REVOGADO pelo líder** (`C-08` da L-29, `GODS_LAWS.md`, 25/08/2026; a regra antiga bania conquistas e placar, e foi apagada sob a L-24). **O jogo TEM conquistas** (afirmado pelo líder ao revogar o corte). ⚠️ **Correção de 28/08/2026:** o corte era composto e a revogação de 25/08 valeu só pela metade das conquistas — **o placar continua cortado**, e o `C-08` voltou à L-29 estreitado, banindo só placar e ranking entre jogadores. Motivo do líder: o jogo é single-player e offline (`C-01`), um ranking não teria com quem comparar. **O que continua de fora, por ora:** integração com a Steam, por depender do SDK proprietário do Steamworks, incompatível com a AGPL-3.0 herdada do GlintFx; decidida quando a distribuição for real.
