...
Versão: 0.2 (pré-produção, F1.12-REFRESH 2026-06-02; higienização de stack 2026-06-23). Escopo solo G1, engine própria C++23 + __DEP_REMOVIDA__ (ADR-008), PC Linux v1 (Windows pós-v1), single-player.
