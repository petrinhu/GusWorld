...
> **RESGATADO em 25/08/2026 do `gusworld_legacy`.** Registro do outreach já ENVIADO pelo líder ao projeto 8values em 2026-07-11 (issue #185, texto mantido verbatim por ser registro do que foi de fato enviado). O próprio texto já documenta que os links pra Codeberg morreram na migração de 2026-07-25; hoje o GusWorld é só GitHub (`github.com/petrinhu/GusWorld`). Preservado por ser comunicação externa real e já pública, não por ser lore ou canon.
