...
**FRAME FUNDACIONAL FECHADO (a canonizar via narrative-writer em `cosmologia-deep.md`):** análogos convergentes (nao a Terra) + duas camadas (mito ambiguo na superficie / verdade enterrada de endgame) + Helíaco Vyr como o mago de hubris tragico cujo feito na Catedral-Mae fraturou a realidade. PENDENTE: (a) nome canonico do evento ("Estilhacamento" = placeholder); (b) roster de analogos (quais figuras reais → quais identidades GusWorld: um Faraday-eletromagnetismo, um Maxwell-campo, um Einstein-espacotempo, um Musk-industrial-visionario, Hayek/Mises-econ austriaca + ampliacao com matematicos/fisicos/ocultistas/economistas); (c) como o mecanismo de "eco convergente" funciona.
