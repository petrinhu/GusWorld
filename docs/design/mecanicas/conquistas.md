...
**Gatilho de domínio, REESCRITO em 05/09/2026 (decisão do líder):** o contador de derrotas deixa de ser o gatilho. Conceder o Token depois de um número de derrotas era gatilho por desempenho, e o corte `C-06` (L-29) proíbe dificuldade que se adapta ao desempenho do jogador — mesmo quando o ajuste é uma ajuda ao jogador travado, não uma facilitação disfarçada do lado do inimigo, é o mesmo tipo de gatilho que o corte veta. O gatilho passa a ser a **dificuldade escolhida no save**, sem depender de quantas vezes Gus foi derrotado na cena. A escala por dificuldade da cura (tabela abaixo) e a concessão de uma vez por identidade de cena continuam valendo — só o que dispara a concessão muda. **Não decidido aqui, e não inventado por presunção de simetria com §2.12:** o instante exato, dentro da cena, em que a dificuldade do save passa a disparar a concessão (ex.: ao entrar na cena, ao primeiro combate dela, outro evento de domínio já nomeado); fica como pergunta nova ao líder.

**Estado mínimo a contar, REESCRITO em 05/09/2026:** como o gatilho deixou de ser contagem de derrotas, o mapa `id_cena → contagem de derrotas` de §2.12 deixa de alimentar esta linha. O estado mínimo passa a ser só a dificuldade do save (já lida do envelope selado, L-25) e o conjunto de identidades de cena que já receberam o Token (para a idempotência por cena, ver "Estado inválido" abaixo). Isto não afeta o contador de §2.12, que segue existindo para aquela conquista.
...
**Estado inválido:** mesma regra 3 do §0 para o aspecto conquista; para o aspecto sistema de suporte (entrega de item), a idempotência também deveria valer por cena — reentrar na cena depois de já ter recebido o Token naquela identidade de cena não deveria entregar um segundo (redação ajustada em 05/09/2026: a formulação anterior ligava o caso inválido a "a 11ª vez", contagem que a REESCRITA do gatilho acima tornou obsoleta).
