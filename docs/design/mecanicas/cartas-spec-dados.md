...
- `battery_capacity_for(HardwareClass, DifficultyLevel) -> uint32_t` — tabela de `cartas-numeros-proposta.md` §1a (16/42/110/288 · 8/21/55/144 · 4/10/27/72 · 4/10/27/72), com o gap de `PirataEspecialFalso` marcado (AMB-DADOS-01).
