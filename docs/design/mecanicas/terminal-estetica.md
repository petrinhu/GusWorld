...
11. O padrão cresce somando o que veio antes. *(padrão numérico velado, não rotular no jogo)*
12. Três passos pra ler o tabuleiro: observar, prever, agir. *(3 passos, velado)*
