...
**Cartas já foram forjáveis: por que a bancada do jogador nunca cria uma de verdade (decisão do líder, 03/09/2026, verbatim: "Cartas já foram Forjáveis, mas a tecnomagik para isso se perdeu. ATUALMENTE, nao se forja mais em casa, apenas em indústrias de tecnomagik").** Três fatos, na ordem em que o líder os deu: forjar carta **foi** possível no passado; a technomagik que permitia isso **se perdeu**; hoje **não se forja em casa**, só em **indústrias de technomagik**. Isto não revoga nada do que este §3 já fixa; ao contrário, **sustenta** o anti-pillar acima ("cartas são obtidas, não craftadas; o jogador nunca monta carta nova numa bancada") com uma razão histórica: a bancada caseira nunca fez mais do que copiar porque a technomagik de forjar de verdade não existe mais fora de indústria: mesmo homebrew de COMUM, o mais aberto dos três tipos, é cópia (§2), nunca criação. Também explica, sem contradizer nada, por que "Forja do Vértice" é nome legítimo do consórcio industrial de Helion Tusk (`docs/design/roster-analogos/21-helion-tusk.md`): é uma indústria de technomagik de verdade, do tipo que ainda forja, num sentido que a bancada de um jogador jamais alcança.
