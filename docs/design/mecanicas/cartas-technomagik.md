...
- **Carta ORIGINAL, nunca forjada (correção 25/08/2026, decisão do líder):** a SUPER não é criada nem montada por ninguém, nem pela party, nem por Tusk. Ela é a peça original, escrita em **asmódico puro**, num **compilador próprio que se perdeu ao longo do tempo**. Nenhuma bancada a gera: a party não a fabrica combinando as 20 ESPECIAIS como componente de um ritual de criação. **As 20 ESPECIAIS coletadas continuam sendo pré-requisito duro**, mas como condição de **acesso** à missão-capstone, não como matéria-prima que vira a carta.
