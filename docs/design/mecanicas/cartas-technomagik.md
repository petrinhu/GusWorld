...
- **Lacuna (1), fechada em 05/09/2026, decisão do líder:** a reanimação dos zumbis do Pântano de Markov é ilimitada; sem `SigKill` (ou equivalente futuro) o zumbi não fica caído por número de golpes nenhum, e reanima sempre com o HP cheio de novo. Não existe fração residual, e a área não é limpável só à base de dano. Detalhe em `docs/narrative/environments/02-selve-sombria.md` §11.
