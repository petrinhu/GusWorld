...
- **Autoria (fechada 25/08/2026, rodada 3, decisão do líder):** foi o próprio **Helion Tusk quem escreveu a carta**, em asmódico puro, e quem escreveu o **compilador** dela, em asmódico e C-Arcane. O compilador não se "perdeu" por acidente: **Tusk mesmo o apagou**, ato deliberado, ao medir o perigo que ele seria pro GusWorld se caísse nas mãos de **Patch-Zero** ou de **Sterling Locke**. Isso fecha o "compilador próprio que se perdeu ao longo do tempo" do bullet acima como ato do próprio autor, não como perda por desgaste. **Não muda nada do resto**: lugar, caminho e mecanismo de entrega da carta escondida seguem abertos (bullet seguinte), e Tusk **não é longevo**: a menção do líder à poção de Brunus Vetorial nesta mesma rodada foi tema ("ética acima da fama"), não mecanismo biológico compartilhado; a regra de que Brunus foi a única cobaia do próprio experimento continua intacta. Detalhe completo em `docs/design/roster-analogos/21-helion-tusk.md` §"O clímax"; tema registrado em `docs/narrative/arco-principal.md` §"Theme central".
- **Foi Tusk quem a escondeu, e não é na Forja do Vértice (princípio fechado 25/08/2026, rodada 2, decisão do líder):** perguntado entre "na Forja do Vértice", "escondida pelo próprio Tusk em outro lugar" e "o líder diz onde", a resposta foi a segunda opção, verbatim: "opcao dois, mas ainda precisamos pensar onde, como chega etc". Isso fecha que o esconderijo é ato deliberado do próprio Tusk, e que a Forja do Vértice está descartada como local. **O lugar exato, o caminho até lá e o mecanismo pelo qual a party recebe a carta ao fim da missão-capstone continuam em aberto por decisão explícita do líder** — a redação anterior, "forjada... na bancada do Tusk", descrevia um mecanismo que caiu junto com a palavra "forjada", e o mecanismo que o substitui ainda não foi decidido. Nenhum agente deve preencher lugar, caminho ou mecanismo de entrega por conta própria. Detalhe completo do princípio e do que segue aberto em `roster-analogos/21-helion-tusk.md`, seção "O clímax: a chegada até a Carta 21".
