...
Família **Universal** · categoria **Híbrida** · especial · mana 6 · 1×/batalha · face passiva com dois gastos de mana/bateria (standby + disparo, números pendentes; decisão do líder, 03/09/2026, ver `cartas-hardware-pirataria-energia.md` §5).
...
O mecanismo de clone **não** adiciona um ator novo à fila de combate: reaplica o último golpe do próprio portador, sem entidade nova nenhuma (`bruno.gw.card`, a carta irmã). A vantagem prática é não mexer no tamanho fixo da party (3, canon deste projeto).
