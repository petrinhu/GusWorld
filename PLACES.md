...
| **Câmara comemorativa Lúcio Ostraconis** | Sub-local (São Camilo) | 3 (memorial Era 1) | Catedral de São Camilo, exibe pingente cerâmico reduzido | ✅ canônico (em uso ativo Ordem Recursiva) | `deep/eras/era-1-pre-codigo.md` §6.5 |
| **Banco litúrgico Catedral de São Camilo** | Sub-local (São Camilo) | 3 (vitrine Era 1) | Vitrine fria que exibe placa conjunta assinada por Helíaco Vyr + Cira Boroshova | ✅ canônico (em uso ativo Ordem Recursiva) | `deep/eras/era-1-pre-codigo.md` §6.3 |
| **Câmara fria principal arquivo lítico São Camilo** | Sub-local (São Camilo) | 3 (preserva Era 1) | Sob nave principal, preserva 23 placas canônicas do Codex Cantata + cordós originais | ✅ canônico (em uso ativo Ordem Recursiva) | `deep/eras/era-1-pre-codigo.md` §6.2 + §6.4 + §6.5 |
| **Câmara reservada (dossiês paralelos)** | Sub-local (São Camilo) | 3 (preserva Era 1) | Reservada, acesso restrito Mestre-Hierofante + Inquisidor-Mestre atual; ~40 dossiês históricos Era 1 | ✅ canônico (em uso ativo Ordem Recursiva) | `deep/eras/era-1-pre-codigo.md` §6.6 |
...
| **Quatro Bancos Subordinados (Atelaiá, São Vargas, São Camilo, Quarta)** | Sub-locais (Catedrais menores) | 1 derivados | Anexos das 4 catedrais menores | parcial (São Camilo ✅ ativo Ordem Recursiva; Atelaiá/Vargas 🔴 saqueados; Quarta ✅ ativo) | `deep/eras/era-1-pre-codigo.md` §7.1 |
