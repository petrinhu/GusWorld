...
| **Vilarejo do Acaceiro Antigo** | Vilarejo-fronteira | Cross-eras (fundado -720) | Região noroeste da Catedral-Mãe submersa | ✅ canônico (descendência direta Família-Pilastra Argéndia) | `deep/eras/era-1-pre-codigo/capitulo-09-02-vestigios-biologicos-sementes-fungos-flora.md` + `deep/eras/era-1-pre-codigo/capitulo-09-05-vestigios-genealogicos-vance-pilastra-prospero.md` |
| **Vilarejo do Vale Ferraz** | Vilarejo-fronteira | Cross-eras (fundado -720) | Região central, descendência Família-Pilastra Ferraz | ✅ canônico (variedade canônica de milho ferraz) | `deep/eras/era-1-pre-codigo/capitulo-09-02-vestigios-biologicos-sementes-fungos-flora.md` + `deep/eras/era-1-pre-codigo/capitulo-09-05-vestigios-genealogicos-vance-pilastra-prospero.md` |
| **Vilarejo da Margem-do-Pelicano** | Vilarejo-fronteira | Cross-eras (fundado -720) | Região meridional, descendência Família-Pilastra Vanderbist | ✅ canônico (variedade canônica de batata-de-margem; sob proteção Pelicano Branco) | `deep/eras/era-1-pre-codigo/capitulo-09-02-vestigios-biologicos-sementes-fungos-flora.md` + `deep/eras/era-1-pre-codigo/capitulo-09-06-vestigios-cartograficos-trilhas-arqueologia.md` |
| **Vilarejo da Selve-do-Norte** | Vilarejo-fronteira | Cross-eras (fundado -720) | Região setentrional, descendência Família-Pilastra | ✅ canônico (variedade canônica de raiz-amarga) | `deep/eras/era-1-pre-codigo/capitulo-09-02-vestigios-biologicos-sementes-fungos-flora.md` + `deep/eras/era-1-pre-codigo/capitulo-09-06-vestigios-cartograficos-trilhas-arqueologia.md` |
| **Vilarejo da Pedra-Cantante** | Vilarejo-fronteira | Cross-eras (fundado -720) | Região oriental, descendência Família-Pilastra | ✅ canônico (variedade canônica de erva-de-pedra) | `deep/eras/era-1-pre-codigo/capitulo-09-02-vestigios-biologicos-sementes-fungos-flora.md` + `deep/eras/era-1-pre-codigo/capitulo-09-06-vestigios-cartograficos-trilhas-arqueologia.md` |
| **Vilarejo do Vale Boroshova** | Vilarejo-fronteira | Cross-eras (fundado -720) | Refúgio canônico da Linhagem Boroshova-Vance | ✅ canônico (origem Vesperina Boroshova-Vance, Anselmo Boroshova-Vance, Praxídice Boroshova-Vance) | `deep/eras/era-1-pre-codigo/capitulo-08-a-queda-multi-hipotese-canonica.md` §8.4 + `deep/eras/era-1-pre-codigo/capitulo-09-03-vestigios-linguisticos-cripto-glifo-asmodico.md` + `deep/eras/era-1-pre-codigo/capitulo-09-05-vestigios-genealogicos-vance-pilastra-prospero.md` + `deep/eras/era-1-pre-codigo/capitulo-09-07-periodo-obscuro.md` |
...
| **Ferrovelhos (Periferia Industrial)** | Sub-local / zona jogável da Periferia | 2 + 3 | Distrito 2 da Periferia (lore-bible §5.1): ferro-velho, sucata, oficinas independentes; **lar do Dante**; atuação da FIR; campus temático de 4 mestres (economia austríaca: Menger/Hayek/Mises/Bastiat); missão M1 do mini-mapa (implante). Zona jogável autônoma da Periferia (dungeon "reduto do Dante" + 2 lugares secretos) | ✅ canônico (linha adicionada 2026-07-14, achado PS-G4) | `docs/design/mundo-topologia.md` + `lore-bible.md` §5.1 + `docs/design/mecanicas/mini-mapa.md` |
...
| **Subsolo do Edifício Vance** | Sub-local (dentro do Edifício Vance, distinto do apartamento) | 2 (~-90 a -70, prédio) + 3 (uso Pyotor, depois Gus) | Núcleo Metropolitano, subsolo do prédio (não da unidade Vance) | ✅ canônico (bancada deixada por Pyotor Vance, hoje usada pelo Gus; piso inteiro coberto por carpete; alçapão sob o carpete — o que fica embaixo dele não é canonizado) | `environments/01-cidade-cyber-gotica.md` + `CHARS.md` §4 |
...
| **Caverna dos Perdidos** | Sub-local (Selve Sombria) | 1 (origem ancestral) + 3 (Sterling usa) | **Subterrânea profunda Selve Sombria, nordeste do Pântano Markov, abaixo de raízes ancestrais. Passagem secreta conhecida só por Sterling brass. Família Dante (mãe Edilma Alencar) presa lá pra chantagear Dante** (canon arco Dante Beat Ten reveal) | ✅ canônico (reveal arco Dante) | `docs/narrative/deep/dragon-victory-deep.md` + `docs/narrative/deep/characters/dante-grid.md` R4 |
| **Castelo Vance** | Sub-local (geográfico histórico Era 1) | 1 (último uso ~-720) | Local não-precisado, cenário cutscene Dragon Victory. Defendido por Pyotor I Draco Vance + Vyrdragon contra cerco em Era 1 | ✅ histórico Era 1 (canon cutscene) | `docs/narrative/deep/dragon-victory-deep.md` |
...
| **Rota da Semente Recursiva** | Sub-local (rota etnobotânica Era 2) | 2 tardia (-250 a -130) | Circulação entre os 5 vilarejos-fronteira canônicos | ✅ canônico (ciclo institucional de aproximadamente 13 meses; circulação descentralizada de sementes-relíquia preservadas em ampolas herméticas) | `deep/eras/era-1-pre-codigo/capitulo-09-02-vestigios-biologicos-sementes-fungos-flora.md` |
...
| **Montadora Confluência** | Sub-local (Selve Profunda, borda) | 3 | Borda da Selve Profunda. Montadora de carros elétricos mágicos flutuantes do consórcio industrial do Helion Tusk; usa sucata da FIR/Ferrovelhos pra baratear a produção E ser eco-friendly, MAS não usa só sucata (indústria de tecnologia de PONTA: sucata reciclada + materiais de ponta). Ligação com o passado do Dante (garoto da Periferia que corria sucata pra lá); foreshadow discreto da Forja do Vértice. **VISITÁVEL (atualizado 2026-07-14): vira repositório da missão de VRAM do mini-mapa** (forjar o chip na linha do Tusk; `docs/design/mecanicas/mini-mapa.md` §0.2) | ✅ canônico | `docs/design/roster-analogos/21-helion-tusk.md` + `mini-mapa.md` |
...
- **CHARS.md** em `CHARS.md` (raiz deste repositório; inventário canônico de personagens; complementar a este)
